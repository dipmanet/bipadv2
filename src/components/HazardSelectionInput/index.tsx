...
import { hazardTypeListSelector, hazardTypesSelector, languageSelector } from "#selectors";
...
const compareHazard = (a, b) =>
	compareNumber(hazardTypeOrderSelector(a), hazardTypeOrderSelector(b));
...
class HazardSelectionInput extends React.PureComponent {
	...
	handleInputChange = () => {
		...
		const newValue = [...this.naturalInputValue, ...this.artificialInputValue];
...
export default FaramInputElement(connect(mapStateToProps)(HazardSelectionInput));
