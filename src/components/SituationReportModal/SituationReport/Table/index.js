							...
							<thead>
								<tr>
									...
									{data.map((hazardGroup) =>
										language === "en" ? (
											<th>{(hazardTypes[hazardGroup.key] || {}).title || ""}</th>
										) : (
											<th>{(hazardTypes[hazardGroup.key] || {}).titleNe || ""}</th>
										)
									)}
									<th>{t("Total")}</th>
								</tr>
						...
						{(t) => (
							<tbody>
								<tr>
									...
									{data.map((hazardGroup) => (
										<td>{hazardGroup.peopleDeathCount || 0}</td>
									))}
								...
								<tr>
									...
									{data.map((hazardGroup) => (
										<td>{hazardGroup.peopleInjuredCount || 0}</td>
									))}
								...
								<tr>
									...
									{data.map((hazardGroup) => (
										<td>{hazardGroup.peopleMissingCount || 0}</td>
									))}
								...
								<tr>
									...
									{data.map((hazardGroup) => (
										<td>{hazardGroup.peopleAffectedCount || 0}</td>
									))}
								...
								<tr>
									...
									<td colSpan="2">{t("Affected")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.familyAffectedCount || 0}</td>
									))}
								...
								<tr>
									...
									{data.map((hazardGroup) => (
										<td>{hazardGroup.familyRelocatedCount || 0}</td>
									))}
								...
								<tr>
									...
									{data.map((hazardGroup) => (
										<td>{hazardGroup.familyEvacuatedCount || 0}</td>
									))}
								...
								<tr>
									...
									<td colSpan="2">{t("Affected")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.livestockAffectedCount || 0}</td>
									))}
								...
								<tr>
									...
									{data.map((hazardGroup) => (
										<td>{hazardGroup.livestockDestroyedCount || 0}</td>
									))}
								...
								<tr>
									...
									<td>{t("House")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureDestroyedHouseCount || 0}</td>
									))}
								...
								<tr>
									<td>{t("Bridge")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureDestroyedBridgeCount || 0}</td>
									))}
								...
								<tr>
									<td>{t("Road")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureDestroyedRoadCount || 0}</td>
									))}
								...
								<tr>
									<td>{t("Electricity")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureDestroyedElectricityCount || 0}</td>
									))}
								...
								<tr>
									...
									<td>{t("House")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureAffectedHouseCount || 0}</td>
									))}
								...
								<tr>
									<td>{t("Bridge")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureAffectedBridgeCount || 0}</td>
									))}
								...
								<tr>
									<td>{t("Road")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureAffectedRoadCount || 0}</td>
									))}
								...
								<tr>
									<td>{t("Electricity")}</td>
									{data.map((hazardGroup) => (
										<td>{hazardGroup.infrastructureAffectedElectricityCount || 0}</td>
									))}
