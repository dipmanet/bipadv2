...
const DetailsSecondPage = (props: Props) => {
	...
	const { pending, closeModal, updatePage, submit, uploadedLetter, serverErrorMsg } = props;
						...
						<div className={styles.formContainer}>
							...
							<div className={styles.newSignupForm}>
								...
								{serverErrorMsg && showErr ? (
									<span className={styles.captchaErr}>{serverErrorMsg}</span>
								) : (
									""
								)}
								{serverErrorMsg ? <span className={styles.captchaErr}>{serverErrorMsg}</span> : ""}
							</div>
						</div>
