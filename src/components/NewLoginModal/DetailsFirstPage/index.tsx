...
const DetailsFirstPage = (props: Props) => {
	...
	const { pending, closeModal, updatePage, signupRegion, municipality, district, province } = props;
					...
					<div className={styles.detailsFormContainer}>
						...
						<div className={styles.formContainer}>
							...
							<div className={styles.newSignupForm}>
								...
								{errMsg && showErr ? (
									<span className={styles.errMsg}>{t("Please select at least one field")}</span>
								) : (
									""
								)}
							</div>
						...
						<div className={styles.cancelAgreeBtns}>
							...
							<PrimaryButton type="button" className={styles.agreeBtn} onClick={handleAgreeBtn}>
								{t("Next")}
							</PrimaryButton>
						</div>
					</div>
