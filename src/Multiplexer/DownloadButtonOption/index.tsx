				...
				<div className={styles.mainContainer} id="downloadButtonOption123">
					...
					<div className={styles.buttonOptions}>
						...
						{showCustomSetting ? (
							...
							<Button className={styles.downloadButton} onClick={this.handleCustomDownloadClick}>
						...
						{showCustomSetting ? (
							<>
								...
								{showPageType === "true" ? (
									<div>
										<form className={styles.pageType}>
											<label htmlFor="Custom">Select Page Type :</label>
											<div>
												<Button
													className={_cs(
														selectedPageType === "A3" ? styles.active : styles.pageSizeButton
													)}
													onClick={() => {
														this.setState({
															selectedPageType: "A3",
												...
												<Button
													className={_cs(
														selectedPageType === "A4" ? styles.active : styles.pageSizeButton
													)}
													onClick={() => {
														this.setState({
															selectedPageType: "A4",
												...
												<Button
													className={_cs(
														selectedPageType === "B4" ? styles.active : styles.pageSizeButton
													)}
													onClick={() => {
														this.setState({
															selectedPageType: "B4",
												...
												<Button
													className={_cs(
														selectedPageType === "B5" ? styles.active : styles.pageSizeButton
													)}
													onClick={() => {
														this.setState({
															selectedPageType: "B5",
									...
									<div>
										<form className={styles.pageType}>
											<label htmlFor="Custom">Resolution :</label>
										...
										{height > 499 && height < 5001 && width > 499 && width < 5001 ? (
											...
											<h5 style={{ textAlign: "right", marginRight: "10px", color: "#E35163" }}>
												Max value 5000 & Min value 500
											</h5>
										)}
									</div>
								)}
								{showPageType === "true" ? (
									<div>
										<form className={styles.pageType}>
											<label htmlFor="Custom">Orientation :</label>
											<div>
												<Button
													className={_cs(
														mapOrientation === "landscape" ? styles.active : styles.pageSizeButton
													)}
													onClick={() => {
														this.setState({
												...
												<Button
													className={_cs(
														mapOrientation === "portrait" ? styles.active : styles.pageSizeButton
													)}
													onClick={() => {
														this.setState({
															mapOrientation: "portrait",
								...
								<div>
									<form className={styles.pageType}>
										<label htmlFor="Custom">File format :</label>
										<div>
											<Button
												className={_cs(
													selectedFileFormat === "png"
														? styles.activeFileFormatButton
														: styles.fileFormatButton
												)}
								...
								<div className={styles.footerButton}>
									{!isTilesLoaded ? (
										...
										<MapDownloadButton
											// className={styles.mapDownloadButton}
											className={
												disableDownloadButton ? styles.disableButton : styles.downloadButton
											}
											// transparent
									...
									<Button className={styles.cancelButton} onClick={this.handleCancelButton}>
										Cancel
									</Button>
								</div>
							</>
