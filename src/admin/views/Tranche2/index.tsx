...
const Tranche2 = (props) => {
	...
	const handleFileInputChange = (e) => {
		...
		if (e.target.name === "temporary_shelter_damaged_house" && !allowedExtensions.exec(file.name)) {
	...
	const handleClick = () => {
		...
		errorCheckingFields.map((i) => {
			if (!data[i]) {
				...
				return (i === "application_file" || i === "application_date") && !isApplicationClicked
						...
						{fetchedData ? (
							...
							fetchedTranche2Data.length !== 0 ? (
								<div
									...
									<div className="mainDataEntrySection123" ref={(el) => (componentRef = el)}>
										<div className="formGeneralInfo123">
											<h2>अनुुसूूची ४</h2>
											<h2>दफा ४ को उपदफा(२) सँँग सम्बन्धित</h2>
											<h2 style={{ textDecoration: "underline" }}>
												विपद् प्रभावितको अस्थायी आवासको दोस्रो किस्ता पाउन गरेेको निवेेदन
											</h2>
										</div>
										<div
										...
										<div
											...
											<span>
												{fetchedData &&
													municipalityNameConverter(fetchedData.operatingMunicipality)}
											</span>
										</div>
										...
										<div
											...
											<span>विषयः विपद् प्रभावितको अस्थायी आवासको दोस्रो किस्ता पाऊँँ ।</span>
										</div>
										...
										<div className="formDetails123">
											<p style={{ margin: 0 }}>
												{`विपद् प्रभावितको अस्थायी आवास निर्माणका लाागि ${districtNameConverter(
												...
												} को ${fetchedData.grandChildRelation} श्री ${fetchedData.parentName}
                                                              को ${
													...
													fetchedData.beneficiaryAge
                                                                 ...
                                                                 `}
												मिति {dateFormatter(fetchedData.entryDateBs)} मा भएको अस्थायी आवास निर्मााण
												सम्झौता बमोजिम प्रथम किस्ता रकमबाट आवास निर्मााण भइरहेको/सम्पन्न भएकोलेे सो
												को फोटो यसैै साथ संंलग्न गरी दोस्रो किस्ता भुक्तानी पाउनको लागि निवेेदन पेेश
												गरेेको छुु ।
											</p>
										</div>
										<div
											...
											<div>
												...
												<div
													...
													<span>
														नोटः अस्थायी आवासको दुई तर्फका मोहोडाको फोटो यसैै निवेदनका साथ संंलग्न
														गर्ने ।
													</span>
												</div>
											</div>
										...
										<div className={styles.mainTempAddress}>
											...
											<div
                                                ...
                                                आवास निर्मााण अनुदान मापदण्ड, २०८१ तथा मिति ${dateFormatter(
													...
													मा भएको सम्झौता बमोजिम नै अस्थायी आवास निमाण भइरहेको/समपन्न भएको देेखिएको
													हुँदा निजलाई दोस्रो किस्ता भुक्तानी दिन उपयुक्त छ भनी सिफाारिस गर्दछौंं।
												</p>
											</div>
										</div>
										<div
												...
												<div
													...
													<div
														...
														<img
															...
															height={150}
															width={150}
															src={fetchedTranche2Data[0].temporaryShelterDamagedHouse}
															alt="img"
														/>
													</div>
												</div>
												...
												<div
													...
													<div
														...
														<img
															...
															height={150}
															width={150}
															src={fetchedTranche2Data[0].temporaryShelterPhotoFront}
															alt="img"
														/>
													</div>
												</div>
												<div
													...
													<div
														...
														<img
															...
															height={150}
															width={150}
															src={fetchedTranche2Data[0].temporaryShelterPhotoBack}
															alt="img"
														/>
													</div>
												</div>
								...
								<>
									...
									<div className={styles.mainDataEntrySection}>
										...
										<div>
											<div>
												<div
													...
													<span style={{ textDecoration: "underline" }}>आवेदन उपलब्ध छ ?</span>
															...
															<div style={{ display: "flex" }}>
																<div
																	...
																	<img
																		height={100}
																		width={100}
																		src={handleShowImage(data.temporary_shelter_damaged_house)}
																		alt="img"
																	/>
																</div>
															</div>
										...
										<div
											...
											<h2>
												{" "}
												{`${englishToNepaliNumber(2)}. अस्थायी आवासको दुुई तर्फका मोहोडाको फोटो`}
											</h2>
											<div
												style={{
													display: "flex",
...
export default connect(
	mapStateToProps,
	mapDispatchToProps
)(createConnectedRequestCoordinator<ReduxProps>()(createRequestClient(requests)(Tranche2)));
