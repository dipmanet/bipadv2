...
const TemporaryShelter = (props: {
  ...
  const handleRemoveImage = (id: number) => {
    const filteredArray = data.infrastructure_photo.filter(
      (i, idx) => idx !== id
    );
  ...
  const handleFileInputChange = (e: {
    ...
    if (
      e.target.name === "beneficiary_photo" &&
      !profilePicValidation.exec(file.name)
    ) {
    ...
    if (
      e.target.name === "identity_document" &&
      !allowedExtensions.exec(file.name)
    ) {
    ...
    // imageValidation.infrastructure_photo_validation = false;
    if (
      e.target.name === "application_document" &&
      !allowedExtensions.exec(file.name)
    ) {
  ...
  const selectedMunicipality = municipalities.filter(
    (i: { district: number }) =>
      i.district === Number(data.beneficiary_district)
  );
  ...
  const selectedWard = user.isSuperuser
      ...
      wards
        .filter(
          (i: { municipality: number }) =>
            i.municipality === Number(data.beneficiary_municipality)
        )
        .sort(
    ...
    : user &&
      ...
      wards
        .filter(
          (i: { municipality: any }) =>
            i.municipality === user.profile.municipality
        )
        .sort(
          (a: { title: any }, b: { title: any }) =>
            Number(a.title) - Number(b.title)
  ...
  const tempSelectedMunicipality = user.isSuperuser
    ? user &&
      ...
      municipalities.filter(
        (i: { district: number }) =>
          i.district === Number(data.temporary_shelter_land_district)
      )
    : user &&
      user.profile &&
      municipalities.filter(
        (i: { district: number }) =>
          i.district === Number(user.profile.district)
      );
  ...
  const beneficiarySelectedMunicipality = municipalities.filter(
    (i: { district: number }) =>
      i.district === Number(data.beneficiary_representative_district)
  );
    ...
    ? user &&
      ...
      wards
        .filter(
          (i: { municipality: number }) =>
            i.municipality ===
            Number(data.beneficiary_representative_municipality)
        )
        .sort(
          (a: { title: any }, b: { title: any }) =>
            Number(a.title) - Number(b.title)
  ...
  const handleClick = () => {
    ...
    errorCheckingFields.map((i) => {
      if (!data[i]) {
        if (!data.is_beneficiary_available_to_sign) {
          ...
          latestErrorUpdate.beneficiary_representative_citizenship_number =
            false;
        ...
        return user.isSuperuser &&
          ...
          : !data.is_beneficiary_available_to_sign &&
            i === "beneficiary_representative_ward"
          ? (latestErrorUpdate[i] = false)
          : (i === "application_file" || i === "application_date") &&
    ...
    finalFormData.append(
      "grand_parent_name",
      finalUpdateData.grand_parent_name
    );
    finalFormData.append(
      "grand_child_relation",
      finalUpdateData.grand_child_relation
    );
    ...
    finalFormData.append(
      "beneficiary_name_english",
      finalUpdateData.beneficiary_name_english
    );
    finalFormData.append(
      "beneficiary_contact_number",
      finalUpdateData.beneficiary_contact_number
    );
    finalFormData.append(
      "beneficiary_citizenship_number",
      finalUpdateData.beneficiary_citizenship_number
    ...
    finalFormData.append(
      "beneficiary_photo",
      finalUpdateData.beneficiary_photo
    );
    finalFormData.append(
      "beneficiary_representative_citizenship_number",
    ...
    finalFormData.append(
      "bank_account_holder_name",
      finalUpdateData.bank_account_holder_name
    );
    finalFormData.append(
      "bank_account_number",
      finalUpdateData.bank_account_number
    );
    ...
    finalFormData.append(
      "withness_name_nepali",
      finalUpdateData.withness_name_nepali
    );
    finalFormData.append(
      "withness_relation",
      finalUpdateData.withness_relation
    );
    finalFormData.append(
      "withness_contact_number",
      finalUpdateData.withness_contact_number
    );
    finalFormData.append(
      "operating_municipality_officer_name",
    ...
    finalFormData.append(
      "identity_document",
      finalUpdateData.identity_document
    );
    finalFormData.append(
      "application_document",
      finalUpdateData.application_document
    );
    finalFormData.append("police_report", finalUpdateData.police_report);
    finalFormData.append(
      "beneficiary_district",
      finalUpdateData.beneficiary_district
    );
    finalFormData.append(
      "beneficiary_municipality",
      finalUpdateData.beneficiary_municipality
    );
    ...
    finalFormData.append(
      "operating_municipality",
      finalUpdateData.operating_municipality
    );
  ...
  const districtNameConverter = (id: any) => {
    const finalData =
      id && districts.find((i: { id: number }) => i.id === Number(id)).title_ne;
  ...
  const municipalityNameConverter = (id: any) => {
    ...
    const finalData =
      id && municipalities.find((i: { id: number }) => i.id === Number(id));
  ...
  const wardNameConverter = (id: any) => {
    const finalData =
      id && wards.find((i: { id: number }) => i.id === Number(id)).title;
    return finalData || "-";
  };
  const handleChange = (
          ...
          <div className={styles.mainForm}>
            ...
            <div className={styles.mainDataEntrySection}>
              ...
              <span style={{ fontSize: "16px" }}>
                {`${englishToNepaliNumber(2)}. ठेगाना`}
              </span>
                      ...
                      {selectedWard.map(
                        (item: {
                          ...
                          <option value={item.id}>
                            {englishToNepaliNumber(item.title)}
                          </option>
                        )
                      )}
                    </select>
                          ...
                          {user.isSuperuser ? (
                            ...
                            >
                              ...
                              <select
                                ...
                                value={
                                  data.beneficiary_representative_district || ""
                                }
                                onChange={handleFormData}
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          >
                            ...
                            <select
                              ...
                              value={
                                data.beneficiary_representative_municipality ||
                                ""
                              }
                              onChange={handleFormData}
                ...
                <div className={styles.firstPartContainer}>
                  <span style={{ fontSize: "16px" }}>
                    {`${englishToNepaliNumber(
                      3
                    )}. बैंंक/वित्तीय संंस्थामा रहेेको खाताको विवरण`}
                  </span>
                  <div className={styles.formElements}>
                    <div style={{ display: "flex", gap: "20px" }}>
                      <div
              ...
              >
                <span style={{ fontSize: "16px" }}>
                  {`${englishToNepaliNumber(
                    6
                  )}.अस्थायी आवास निर्माण हुुनेे जग्गाको विवरण`}
                </span>
                <div style={{ display: "flex", fontSize: "20px", gap: "20px" }}>
                  <div
                    className={styles.tempAddressIndividualDiv}
                    style={{ flex: 1 }}
                  >
                    {user.isSuperuser ? (
                      <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    <div style={{ display: "flex", gap: "20px" }}>
                      ...
                      >
                        ...
                        >
                          <span style={{ color: "red" }}>*</span>
                          <span style={{ fontSize: "14px" }}>
                            प्रमुुख प्रशासकीय अधिकृृतको नामः
                          </span>
                        </div>
              ...
              {Object.values(errorFields).filter((i) => i === true).length ? (
                <span className={styles.ValidationErrors}>
                  रातो रङले संकेत गरेको माथिको फारममा केही फिल्ड भर्न बाँकी छ,
                  कृपया फारम पूरा गर्नुहोस् र पुन: प्रयास गर्नुहोस्
                </span>
              ) : (
                ""
              )}
...
export default connect(
  ...
  createConnectedRequestCoordinator<ReduxProps>()(
    createRequestClient(requests)(TemporaryShelter)
  )
);
