    ...
    .then(final_resp => setPaymentReceiveList(final_resp.results));
      ...
      useEffect(() => {
        ...
        if (fetchedData && fetchedData.allStatus) {
            ...
            setOverallStatusList({
                ...overallStatusList, tempShelterEntrollmentForm: id,
            });
        }
      }, [fetchedData]);
      ...
      <>
          ...
          <div className="container123">
              ...
              padding: '10px 20px',
                ...
                >
                    <div style={{ display: 'flex', padding: '20px', width: '52%', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ display: 'flex', width: '52%', justifyContent: 'space-between', padding: '20px' }}>
...
export default connect(
  ...
  createConnectedRequestCoordinator<ReduxProps>()(
    createRequestClient(requests)(TrancheCondition),
  ),
);
