...
import TemporaryShelterDashboardTable from 'src/admin/components/TemporaryShelterDashboardTable';
import styles from './styles.module.scss';


const TemporaryShelterDashboard = props => (
    <>
                        ...
                        <div className={styles.tableMenuContainer}>
                            <div className={styles.mainContent}>
                                ...
                                <div className={styles.formDataContainer}>
                                    <TemporaryShelterDashboardTable />
                                </div>
