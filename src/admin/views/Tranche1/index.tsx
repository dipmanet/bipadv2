...
const requests: { [key: string]: ClientAttributes<ReduxProps, Params> } = {
  ...
  getEarthquakeTranche1Request: {
    url: ({ params }) =>
      `/first-tranche-enrollment-upload/?temp_shelter_entrollment_form=${params.id}`,
    method: methods.GET,
    onMount: false,
...
const Tranche1 = (props) => {
  ...
  const [nofetchedTranche1DataError, setNofetchedTranche1DataError] =
    useState(false);
  ...
  useEffect(() => {
    ...
    if (id) {
      props.requests.getEarthquakeRequest.do({
        id,
        fetchedData: handleFetchedDataWhole,
              ...
              <div className={styles.mainDataEntrySection}>
                <div className={styles.formGeneralInfo}>
                  ...
                  <h1 style={{ textDecoration: "underline" }}>
                    विपद् प्रभावितको अस्थायी आवास निर्माणका लागि अनुुदान किस्ता
                    १
                  </h1>
                </div>
                            ...
                            >
                              {fetchedData[0].signedCopyFile ? (
                                <a
                                  ...
                                  target="__blank"
                                >
                                  पहिलो किस्ताको हस्ताक्षरित प्रतिलिपि कागजात
...
export default connect(
  ...
  createConnectedRequestCoordinator<ReduxProps>()(
    createRequestClient(requests)(Tranche1)
  )
);
