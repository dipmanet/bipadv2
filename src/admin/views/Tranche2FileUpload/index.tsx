...
const requests: { [key: string]: ClientAttributes<ReduxProps, Params> } = {
  ...
  getEarthquakeTranche1Request: {
    url: ({ params }) =>
      `/second-tranche-enrollment-upload/?temp_shelter_entrollment_form=${params.id}`,
    method: methods.GET,
    onMount: false,
...
const Tranche2FileUpload = (props) => {
  ...
  const [nofetchedTranche2DataError, setNofetchedTranche2DataError] =
    useState(false);
  const {
    user,
    districts,
  ...
  const handleSuccessMessage = (d) => {
    ...
    if (id) {
      props.requests.getEarthquakeTranche1Request.do({
        id,
        ...
        <div className={styles.twoSections}>
          ...
          <div className={styles.mainForm}>
            <div className={styles.generalInfoAndTableButton}>
              <h1 className={styles.generalInfo}>दोस्रो किस्ता फारम अपलोड</h1>
              <button
              ...
              <div className={styles.mainDataEntrySection}>
                <div className={styles.formGeneralInfo}>
                  ...
                  <h1 style={{ textDecoration: "underline" }}>
                    विपद् प्रभावितको अस्थायी आवासको दोस्रो किस्ता पाउन गरेेको
                    निवेेदन
                  </h1>
                </div>
                        ...
                        <span>
                          {`रकम: रु.${
                            fetchedData && fetchedData.length
                              ? englishToNepaliNumber(fetchedData[0].amount)
                              : englishToNepaliNumber(data.amount)
                          }`}
                        </span>
                      </div>
                          ...
                          >
                            ...
                            >
                              {fetchedData[0].signedCopyFile ? (
                                ...
                                <a
                                  href={fetchedData[0].signedCopyFile}
                                  style={{ textDecoration: "underline" }}
                                  target="__blank"
                                >
                                  दोस्रो किस्ताको हस्ताक्षरित प्रतिलिपि कागजात
                ...
                {nofetchedTranche2DataError
                  ? "फाइल अपलोड गर्नको लागि कृपया किस्ता २ फारम भर्नुहोस्"
                  : ""}
                {fetchedData && fetchedData.length ? (
                  ""
                ) : (
...
export default connect(
  ...
  createConnectedRequestCoordinator<ReduxProps>()(
    createRequestClient(requests)(Tranche2FileUpload)
  )
);
