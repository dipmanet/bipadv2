                            ...
                            formtoggler === 'Individual Form'
                                ? (
                                    <p className={styles.ideaPara}>
                                        The table below gives the details of COVID-19 cases reported by
                                        the institution. The table is downloadable and data can be edited as well.
                                    </p>
                                )
                                : (
                                    <p className={styles.ideaPara}>
                                        The table below gives the summary of COVID-19 cases with geographical
                                        information, casualty statistics on total infected, total death, and
                                        total recovered disaggregated by gender, and disability.
