	...
	const downloadFile = () => {
		axios.get(`${baseUrl}/data_template_file/`).then((file) => {
			const template = file.data.results.filter(
				(item) => item.dataTemplateSlug === "heoc_admin_epidemic_group_bulk_upload"
			);
						...
						<div className={styles.thirdRowSection}>
							...
							<div className={styles.mainTableSection}>
								<table className={styles.table}>
									...
									<tbody>
										{uploadData
											.filter((f) => f.dataTemplate === "Epidemic group admin")
											.map((uI, i) => (
...
export default connect(
	...
	createConnectedRequestCoordinator<ReduxProps>()(createRequestClient(requests)(EpidemicBulkUpload))
);
