...
const TemporaryShelterPreview = (props) => {
  ...
  const districtNameConverter = (id) => {
    const finalData =
      fetchedData && districts.find((i) => i.id === id).title_ne;
                ...
                >
                  ...
                  <div className="formDetails123">
                    <p style={{ margin: 0, lineHeight: "25px" }}>
                      ...
                      आवास निर्माण अनुदान कार्यविधि,२०८०, बमोजिम अस्थायी आवास
                  ...
                  <div>
                    ...
                    <div>
                      <h3 style={{ fontWeight: "normal" }}>
                        ...
                        {`${englishToNepaliNumber(
                          1
                        )}. मैलेे विपदबाट प्राभाावित घरपरिवारलाई अस्थायी आवास निर्माण अनुदान कार्ययविधि, २०८० एबंं यस सम्झौता-पत्र अनुरुप बनाउनेे छु ।`}
                      </h3>
                    </div>
                    <div>
                      <h3 style={{ fontWeight: "normal" }}>
                  ...
                  <div>
                    ...
                    <div>
                      <h3 style={{ fontWeight: "normal" }}>
                        {`${englishToNepaliNumber(
                          1
                        )}. प्रथम पक्षबाट यस कार्यविधि अनुसार अस्थायी आवास निर्मााणको कार्य भएमा अनुदान रकम सरकारको तर्फ बाट दफा
                  ...
                  <div>
                    ...
                    {fetchedData.policeReport ? (
                      <div>
                        ...
                        )}. प्रहरीको मुचुल्का (प्रत्येेक घरधुरीको मुचुल्का नभएको अवस्थामा सामुहिक मुचुल्का पनि मान्य हुनेे)`}</h3>
                        {/* <div style={{ display: 'flex', gap: '5px', alignItems: 'flex-start' }}>
                                                                <span style={{ fontSize: '20px' }}>फोटो:</span>
                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
