	...
	return (
		<>
			<div className={styles.formContainer}>
				<Translation>{(t) => <h2>{t("COVID-19 Bulletin")}</h2>}</Translation>
				<Translation>{(t) => <h3>{t("COVID-19 details of the last 24 hrs")}</h3>}</Translation>
				<button type="button" onClick={handleRefreshCovidData} className={styles.nextBtn}>
					Refresh
				</button>
				...
				<Translation>{(t) => <h3>{t("Stats till date")}</h3>}</Translation>
				<div className={styles.formSubContainer}>
				...
				<Translation>{(t) => <h3>{t("Provincewise stats till date")}</h3>}</Translation>
				<div className={styles.formSubContainer}>
