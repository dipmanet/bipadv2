...
import { bulletinEditDataSelector, bulletinPageSelector, languageSelector } from "#selectors";
	...
	return (
		<div className={styles.formContainer}>
			{disableOptionButton ? (
				...
				<FormControl className={styles.optionButton}>
					...
					<RadioGroup
						...
						onChange={(e) => {
							{
								e.target.value === "1" ? handlePromotionPic(null) : handleRainSummaryPic(null);
							}
			...
			{selectedTemperatureImageType === 1 ? (
				...
				<div className={!hideForm ? styles.picContainer : styles.picContainerReport}>
					<PromotionImage promotionPic={promotionPic} handlePromotionPic={handlePromotionPic} />
				</div>
			)}
		</div>
	);
