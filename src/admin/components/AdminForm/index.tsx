...
import SuccessfullyAdded from '../SucessfullyAdded/index';

export const LngLatContext = createContext([]);

const index: React.FC<JSX.Element> = (props) => {
    ...
    }, [adminDataMainId.email, adminDataMainId.firstName, adminDataMainId.id, adminDataMainId.lastName, adminDataMainId.profile.designation, adminDataMainId.profile.institution, adminDataMainId.profile.role, adminDataMainId.username, formDataState, loadingAdminGetId]);
    ...
    }, [provincialData, districtDataMain, municipalityDataMain, wardDataMain, userDataMain]);
    ...
    return (
        <>
            <>
                {(loading && !loadingDistrict && !loadingMunicipality) ? <div>Loading</div>
                    : (
                        <Box>
                                ...
                                <div className={styles.twoSections}>
									...
									Your username will be :
									  ...
									  height: 23,
                                                ...
                                                {/* <select className={styles.hazardInducer}>
