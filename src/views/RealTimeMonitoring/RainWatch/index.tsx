...
import { WaterLevelAverage, RealTimeRain } from "#store/atom/page/types";
	...
	public constructor(props: Props) {
		...
		this.rainWatchHeader = [
			...
			},
			{
				...
				label:
					language === "en"
						? "Accumulated rainfall within last 1 hours"
						: "पछिल्‍लो १ घण्टा भित्र सञ्चित वर्षा",
				order: 4,
				modifier: (row) => {
					const { averages = [] } = row;
			...
			},
			{
				...
				label:
					language === "en"
						? "Accumulated rainfall within last 3 hours"
						: "पछिल्‍लो ३ घण्टामा सञ्चित वर्षा",
				order: 5,
				modifier: (row) => {
					const { averages = [] } = row;
			...
			},
			{
				...
				label:
					language === "en"
						? "Accumulated rainfall within last 6 hours"
						: "पछिल्‍लो ६ घण्टामा सञ्चित वर्षा",
				order: 6,
				modifier: (row) => {
					const { averages = [] } = row;
			...
			},
			{
				...
				label:
					language === "en"
						? "Accumulated rainfall within last 12 hours"
						: "पछिल्‍लो १२ घण्टामा सञ्चित वर्षा",
				order: 7,
				modifier: (row) => {
					const { averages = [] } = row;
			...
			},
			{
				...
				label:
					language === "en"
						? "Accumulated rainfall within last 24 hours"
						: "पछिल्‍लो २४ घण्टामा सञ्चित वर्षा",
				order: 8,
				modifier: (row) => {
					const { averages = [] } = row;
				...
				{(t) => (
					<Modal
						...
						<div className={styles.warning}>
							{t(
								"Note : Warning level for rainfall (mm): 60 mm in 1 hr, 80 mm in 3 hr, 100 mm in 6 hr, 120 mm in 12 hr, 140 mm in 24 hr. This indicates potential threat for landslides in steep slope and high flow in local areas."
							)}
						</div>
						<hr />
						...
						<ModalFooter>
							...
							<DownloadButton value={formattedTableData} name="Rainfall Watch.csv">
								{t("Download")}
							</DownloadButton>
						</ModalFooter>
					</Modal>
