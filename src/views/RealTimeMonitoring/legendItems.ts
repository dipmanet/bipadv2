...
export const riverLegendItems = [
	...
	{
		color: "#FDD835",
		labelNe: "चेतावनी स्तरभन्दा माथि",
		label: "Above Warning Level",
		style: styles.symbol,
	},
	{
		color: "#e53935",
		labelNe: "खतराको स्तरभन्दा माथि",
...
export const newRiverLegendItems = [
	{
		order: 1,
		color: "#7CB342",
		labelNe: "चेतावनी तह भन्दा तल र स्थीर प्रवाह",
		label: "Below Warning Level and Steady",
		style: styles.box,
	},
	{
		order: 2,
		color: "transparent",
		labelNe: "चेतावनी तह भन्दा तल र बढ्दो प्रवाह",
		label: "Below Warning Level and Rising",
		style: styles.triangleRisingBelowWarning,
	},
	{
		order: 3,
		color: "transparent",
		labelNe: "चेतावनी तह भन्दा तल र घट्दो प्रवाह",
		label: "Below Warning Level and Falling",
		style: styles.triangleFallingBelowWarning,
	},
	{
		order: 4,
		color: "#FDD835",
		labelNe: "चेतावनी स्तर माथि र स्थिर",
		label: "Above Warning Level and Steady",
		style: styles.box,
	},
	{
		order: 5,
		color: "transparent",
		labelNe: "चेतावनी स्तर माथि र बढ्दै",
		label: "Above Warning Level and Rising",
		style: styles.triangleRisingAboveWarning,
	},
	{
		order: 6,
		color: "transparent",
		labelNe: "चेतावनीको माथिल्लो तह र गिरावट",
		label: "Above Warning Level and Falling",
		style: styles.triangleFallingAboveWarning,
	},
	{
		order: 7,
		color: "#E53935",
		labelNe: "खतराको स्तर माथि र स्थिर",
		label: "Above Danger Level and Steady",
		style: styles.box,
	},
	{
		order: 8,
		color: "transparent",
		labelNe: "खतराको स्तर माथि र बढ्दै",
		label: "Above Danger Level and Rising",
		style: styles.triangleRisingAboveDanger,
	},
	{
		order: 9,
		color: "transparent",
		labelNe: "खतराको स्तर माथि र झर्दै",
		label: "Above Danger Level and Falling",
		style: styles.triangleFallingAboveDanger,
	},
];
...
export const earthquakeLegendItems = [
	{
		color: "#fee5d9",
		labelNe: "न्यून (2.0 - 3.9)",
		label: "Minor (2.0 - 3.9)",
		radius: 6,
		style: styles.magnitude,
	},
	{
		color: "#fcbba1",
		labelNe: "लाइट (४.० - ४.९))",
		label: "Light (4.0 - 4.9)",
		radius: 8,
		style: styles.magnitude,
	},
	{
		color: "#fc9272",
		labelNe: "मध्यम (५.० - ५.९)",
		label: "Moderate (5.0 - 5.9)",
		radius: 12,
		style: styles.magnitude,
	},
	{
		color: "#fb6a4a",
		labelNe: "बलियो (६.० - ६.९)",
		label: "Strong (6.0 - 6.9)",
		radius: 16,
		style: styles.magnitude,
	},
	{
		color: "#de2d26",
		labelNe: "प्रमुख (७.० - ७.९)",
		label: "Major (7.0 - 7.9)",
		radius: 18,
		style: styles.magnitude,
	},
...
export const pollutionLegendItems = [
	...
	},
	{
		order: 3,
		color: "#ff7300",
		key: "unhealthyForSensitive",
		labelNe: "संवेदनशील समूहहरूका लागि अस्वास्थ्यकर (101 - 150)",
	...
	},
	{
		...
		color: "#8a0014",
		key: "hazardous",
		labelNe: "खतरनाक (३०१ - ४००)",
		label: "Hazardous (301 - 400)",
		style: styles.symbol,
	},
	{
		order: 7,
		color: "#8a0014",
		key: "veryHazardous",
		labelNe: "धेरै खतरनाक (४०१ - ५००)",
		label: "Very Hazardous (401 - 500)",
		style: styles.symbol,
	},
];
...
export const noLegend = [
	{
		color: "transparent",
		labelNe: "प्रदर्शन गर्न कुनै पौराणिक कथाहरू छैनन्",
		label: "No legends to display",
		style: styles.noSymbol,
	},
];
