						...
						<div className={styles.wrapper_tech_support}>
							...
							<div className={styles.feedback_container_second}>
								<div className={styles.tech_support_wrapper}>
									<div className={styles.tech_support_head}>Technical Support Request Form</div>
									...
									{error.descriptionError ? (
										<div className={styles.error_text}>{error.descriptionError}</div>
									) : null}

									<div className={styles.tech_support_date_time}>
										<div className={styles.date_time_head}>Enter your available date and time</div>
									...
									{error ? (
										<div
											...
											{error ? (
												<div className={styles.error_text} style={{ width: "45%" }}>
													{error.dateError}
												</div>
											) : null}
									...
									<div className={styles.tech_support_date_time_text}>
										<Icon name="info" className={styles.info_icon} />
										<span className={styles.info_text}>
											Select the date and time of your availability. You will have 30 minutes
											allocated time per appointment. As per goverment working hours
										</span>
									</div>
								</div>
