...
const FeedbackOne = (props) => {
	...
	const { className, onNextClick, data, setData, error, setError, setPosition, closeModal } = props;
	...
	const inputValidation = () => {
		...
		if (data.othersSpecify) {
			if (!validNameRegex.test(data.otherTechSupport) || data.otherTechSupport === "") {
							...
							<div className={styles.feedback_container_first}>
								<div className={styles.feedback_wrapper}>
									...
									<div className={styles.feedback_button}>
										<Button className={styles.feed_btn} onClick={() => setPosition(1)}>
											FEEDBACK FORM
										</Button>
									</div>
								</div>
								...
								<div className={styles.feedback_input_wrapper}>
									...
									<div className={styles.feedback_support_category}>
										<h3 className={styles.tech_support_head}>
											What technical support would you like to request from BIPAD Team?
										</h3>
										<div className={styles.checkbox_tech_support}>
											<div className={styles.checkbox_wrapper_top}>
												<input
													...
													onChange={(e) =>
														setData({ ...data, technicalTroubleshoot: e.target.checked })
													}
												/>
											...
											<div className={styles.checkbox_wrapper}>
												<input
													...
													onChange={(e) =>
														setData({ ...data, overviewOfBipadPortal: e.target.checked })
													}
												/>
											...
											<div className={styles.checkbox_wrapper}>
												<input
													...
													className={styles.class_checkbox}
													onChange={(e) =>
														setData({ ...data, dataEntryInBipadPortal: e.target.checked })
													}
												/>
												<label htmlFor="data-entry" className={styles.label_technical}>
											...
											<div className={styles.checkbox_wrapper}>
												<input
													...
													className={styles.class_checkbox}
												/>
												<label htmlFor="bipad-data-use" className={styles.label_technical}>
													BIPAD Data Use
												</label>
											</div>
											<div className={styles.checkbox_wrapper}>
												<input
													...
													className={styles.class_checkbox}
													onChange={(e) =>
														setData({ ...data, bipadTechnicalSpecification: e.target.checked })
													}
												/>
												<label
											...
											<div className={styles.checkbox_wrapper}>
												...
												/>
												<label htmlFor="others-specify" className={styles.label_technical}>
													Others (Specify)
												</label>
											</div>
										</div>
									...
									{error.otherSpecifyError ? (
										<div className={styles.error_text}>{error.otherSpecifyError}</div>
									) : null}

									{error.techSupportError ? (
										<div className={styles.error_text}>{error.techSupportError}</div>
									) : null}
									...
									<div
										className={
											error.priorityLevelError ? styles.next_button_on_error : styles.next_button
										}>
										<Button className={styles.nxt_btn} onClick={inputValidation}>
											NEXT
										</Button>
									</div>
								</div>
