							...
							<div className={styles.support_container}>
								<div className={styles.tech_support_wrapper}>
									...
									<div className={styles.tech_support_input}>
										<div className={error.fullNameError ? styles.input_error : styles.input}>
											<input
												...
												className={error.fullNameError ? styles.error : styles.fname}
										...
										<div className={error.fullNameError ? styles.error_text : styles.no_error}>
											{error.fullNameError}
										</div>
										<div className={error.designationError ? styles.input_error : styles.input}>
											<input
												...
												className={error.designationError ? styles.error : styles.designation}
										...
										<div className={error.designationError ? styles.error_text : styles.no_error}>
											{error.designationError}
										</div>
										<div
											className={
											...
											<input
												...
												className={error.nameOfTheInstitutionError ? styles.error : styles.insname}
										...
										<div
											className={
												error.nameOfTheInstitutionError ? styles.error_text : styles.no_error
											}>
											{error.nameOfTheInstitutionError}
										</div>

										<div
											className={error.emailError ? styles.input_email_error : styles.input_email}>
											<input
												type="email"
												name="email"
												disabled={inputField.email}
												placeholder="Official Email"
												className={error.emailError ? styles.error : styles.email}
												value={data.email}
												onChange={formHandler}
												autoComplete="off"
											/>
										</div>
										<div className={error.emailError ? styles.error_text : styles.no_error}>
											{error.emailError}
										</div>

										<div className={styles.verify_div}>
											<span className={styles.verify_head}>
												Select anonymous if you do not want to provide your personal details.
											</span>
											...
											<div className={styles.input_checkbox}>
												<div className={styles.checkbox}>
													<input
														...
														name="verify"
														onChange={(e: any) =>
															setData({ ...data, isAnonymous: e.target.checked })
														}
													/>
												</div>
									...
									<div className={styles.next_button}>
										<Button className={styles.next_btn} onClick={inputValidation}>
											next
										</Button>
									</div>
								</div>
