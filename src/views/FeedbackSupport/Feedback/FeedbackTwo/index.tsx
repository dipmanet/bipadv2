                    ...
                    >
                      ...
                      >
                        ...
                        <div className={styles.comment}>
                          ...
                          <div className={styles.comment_input}>
                            <textarea
                              ...
                              className={error.feedbackError
                                ? styles.error_comment
                                : styles.input_comment}
                        ...
                        <div className={styles.screenshot}>
                          ...
                          <div className={screenshotMessage
                        ...
                        <div className={styles.tech_support_file_choose}>
                          <Icon
                            ...
                            className={
                              screenshotMessage
                                ? styles.info_icon_error
                                : styles.info_icon}
                          />

                          <span className={screenshotMessage
