...
import { districtsSelector, ibfPageSelector, userSelector } from '#selectors';
...
const Navigation = (props: Props) => {
    ...
    const { ibfPage: { selectedStation, stationDetail, filter, householdJson }, setFormOpen, user } = props;
