...
import { ClientAttributes, createRequestClient, methods } from '@togglecorp/react-rest-request';
...
import { getOptions, stateShcema, useFormValidation, validationShcema } from './utils';
...
const HouseForm = ({ mapSelectHandler,
    coordinates,
    setCoordinates,
    requests,
    setFormOpen,
    ...
    const { state, disable, handleChange, handleSubmit, handleReset } = useFormValidation(
        editValue,
        stateShcema,
        validationShcema,
        handleSend,
        ...
        <div className={style.houseFormContainer}>
            ...
            <div className={style.formContainer}>
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        className={_cs(style.formSubmit, disable ? style.disabled : style.allowed)}
                        disabled={disable}
                        type="submit"
