...
const PotentiallyImpacted = ({ impactedValue, setImpactedValue, setIbfPage }: Props) => {
	...
	return (
		<div className={styles.impactContainer}>
			<div className={styles.title}>
				...
				<h1
					className={_cs(
						Object.keys(impactedValue).length > 0 ? styles.activeTitle : styles.baseTitle
					)}>
