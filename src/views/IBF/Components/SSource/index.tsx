		...
		<div
			...
			<div style={{ opacity: toggleSource ? 0 : 1 }} className={style.content}>
				<div className={style.row}>
					<div className={style.col}>Link</div>
					<div>
						<a href="https://globalfloods.eu" target="_blank" rel="noopener noreferrer">
							https://globalfloods.eu
						</a>
					</div>
				</div>
				<div className={style.row}>
					<div className={style.col}>Event Status</div>
					<div style={{ marginLeft: "-10px" }}>Realtime</div>
				</div>
				<div className={style.row}>
					<div className={style.col}>Effective Date</div>
					<div style={{ marginLeft: "-10px" }}>2022-03-13</div>
				</div>
				<div className={style.row}>
					<div className={style.col}>Lead Time</div>
					<div style={{ marginLeft: "10px" }}>10 Days from Effective Date</div>
				</div>
			</div>
			<button
				type="button"
