            ...
            <div className={style.content}>
                ...
                <div className={style.blurpContainer}>
                    <div className={style.blurp}>
                        <div><img className={style.icon} src={source} alt="source" /></div>
                        <div className={style.text}>Source: GloFAS Reporting Points</div>
                    </div>
                    <div className={style.blurp}>
                        <div><img className={style.icon} src={link} alt="link" /></div>
                        <div className={style.text}>Link: https://globalfloods.au</div>
                    </div>
                    <div className={style.blurp}>
                        <div><img className={style.icon} src={date} alt="source" /></div>
                    ...
                    <div className={style.blurp}>
                        <div><img className={style.icon} src={event} alt="event" /></div>
                        <div className={style.text}>Event Status: Real time</div>
                    </div>
                    <div className={style.blurp}>
                        <div><img className={style.icon} src={lead} alt="lead" /></div>
                        <div className={style.text}>Lead time: 10 days from effective Date</div>
                    </div>
                    <div className={style.blurp}>
                        <div><img className={style.icon} src={forecast} alt="forecast" /></div>
                        <div className={style.text}>
                            {'Forecast Date: '}
                            {forecastDate}
                        </div>
