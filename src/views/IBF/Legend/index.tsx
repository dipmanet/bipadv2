...
const Legend = (props: Props) => {
    ...
    const { ibfPage: { stations, filter, selectedIndicator, leadTime, selectedStation, returnPeriod } } = props;
    ...
    const dynamicLegend = (timeLead, stationLists) => {
        ...
        const forLegend = stationLists && stationLists.features.map((feature) => {
                            ...
                            {Object.keys(selectedStation).length === 0 && leadTime !== 0 && filter.municipality === '' ? (
                                            ...
                                            <div className={style.titleNoHover}>Flood Alert</div>
                                            {
                                                dynamicLegendData.map(legendRP => (
                                                    <div>
                                                        ...
                                                        <div className={legendRP === 20 ? style.twenty : legendRP === 5 ? style.five : style.two} />
                                                    </div>
                                                ))
                                            }
                                        </div>
                                ...
                                ? (
                                    ...
                                    <div className={style.legendIndicatorContainer}>
                                        ...
                                        <div className={style.legend} onClick={() => setSelectedLegend('vulnerabilityVeryHigh')}>
                                            {'Very High (6.5 - 10) '}
                                            <div className={style.critical} />
                                        </div>
                                        ...
                                        <div className={style.legend} onClick={() => setSelectedLegend('vulnerabilityMedium')}>
                                            {'Medium (3.5 - 4.9) '}
                                            <div className={style.moderate} />
                                        </div>
                                        ...
                                        <div className={style.legend} onClick={() => setSelectedLegend('vulnerabilityVeryLow')}>
                                            {'Very Low (0 - 1.9) '}
                                            <div className={style.normal} />
                                        </div>
                                    </div>
                                    ...
                                    <div className={style.legendIndicatorContainer}>
                                        ...
                                        <div className={style.legend} onClick={() => setSelectedLegend('lackofcopingVeryHigh')}>
                                            {'Very High (6.5 - 10) '}
                                            <div className={style.critical} />
                                        </div>
                                        ...
                                        <div className={style.legend} onClick={() => setSelectedLegend('lackofcopingVeryLow')}>
                                            {'Very Low (0 - 1.9) '}
                                            <div className={style.normal} />
                                        </div>
                                    </div>
                                    ...
                                    : (selectedIndicator === 'historicalImpactsAndDamage') ? (
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('noHistoricalLossData')}>
                                                {'Data not available'}
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('vicinityLessthan100')}>
                                                {'HHs distance from river < 100 m '}
                                                <div className={style.critical} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('vicinityBetween100and500')}>
                                                {'HHs distance from river 100 to 500 m '}
                                                <div className={style.moderate} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('vicinityMorethan500')}>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('numberOfDependentMorethan2')}>
                                                {'> 2 dependent people '}
                                                <div className={style.critical} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('numberOfDependentBetween1and2')}>
                                                {'1 to 2 dependent people '}
                                                <div className={style.moderate} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('numberOfDependentNone')}>
                                                {'None '}
                                                <div className={style.low} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('noNumberOfDependentData')}>
                                                {'Data not available'}
                                                <div className={style.noImpact} />
                                            </div>
                                        </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('femaleHeadedHousehold')}>
                                                {'Female Headed HHs '}
                                                <div className={style.critical} />
                                            </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('incomeSourceMultiple')}>
                                                {'HHs multiple occupation '}
                                                <div className={style.low} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('noIncomeSourceTypeData')}>
                                                {'Data not available '}
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('annualIncomeMorethan100000')}>
                                                {'> NPR 100,000 '}
                                                <div className={style.low} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('annualIncomeBetween40000and100000')}>
                                                {'NPR 40,000 - 100,000 '}
                                                <div className={style.moderate} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('annualIncomeLessthan40000')}>
                                                {'< NPR 40,000 '}
                                                <div className={style.critical} />
                                            </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('floodImpactInHouseMorethan5')}>
                                                {'> 5 times '}
                                                <div className={style.critical} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('floodImpactInHouseBetween3and5')}>
                                                {'3 to 5 times '}
                                                <div className={style.moderate} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('floodImpactInHouseLessthan2')}>
                                                {'< 2 times '}
                                                <div className={style.low} />
                                            </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('accessToDrinkingWater')}>
                                                {'Access to drinking water '}
                                                <div className={style.low} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('noAccessToDrinkingWater')}>
                                                {'No access to drinking water '}
                                                <div className={style.critical} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('noAccessToDrinkingWaterData')}>
                                                {'Data not available'}
                                                <div className={style.noImpact} />
                                            </div>
                                        </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('earlyWarningInformationAccess')}>
                                                {'Access to EWS '}
                                                <div className={style.low} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('earlyWarningInformationNoAccess')}>
                                                {'No access to EWS '}
                                                <div className={style.critical} />
                                            </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('involvementOfFamily')}>
                                                {'Engagement in CG '}
                                                <div className={style.low} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('noInvolvementOfFamily')}>
                                                {'No engagement in CG '}
                                                <div className={style.critical} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('noFamilyInvolvementData')}>
                                                {'Data not available'}
                                                <div className={style.noImpact} />
                                            </div>
                                        </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('noAccessToFinancial')}>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('educationLevelIlliterate')}>
                                                {'Illiterate '}
                                                <div className={style.critical} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('educationLevelFormal')}>
                                                {'Formal Education '}
                                                <div className={style.moderate} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('educationLevelLiterate')}>
                                                {'Literate '}
                                                <div className={style.low} />
                                            </div>
                                        ...
                                        <div className={style.legendIndicatorContainer}>
                                            ...
                                            <div className={style.legend} onClick={() => setSelectedLegend('thirtyminsToSafeShelter')}>
                                                {'< 30 mins '}
                                                <div className={style.moderate} />
                                            </div>
                                            <div className={style.legend} onClick={() => setSelectedLegend('morethan30minsToSafeShelter')}>
                                                {'> 30 mins '}
                                                <div className={style.low} />
                                            </div>
