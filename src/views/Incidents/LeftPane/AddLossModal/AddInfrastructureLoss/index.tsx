...
import { createRequestClient, ClientAttributes, NewProps, methods } from "#request";

import { MultiResponse } from "#store/atom/response/types";
import { Resource, Status, Field, InfrastructureType } from "#store/atom/page/types";
...
class AddInfrastructureLoss extends React.PureComponent<Props, State> {
	public constructor(props: Props) {
		...
		const {
			requests: { resourceRequest, infrastructureTypeGetRequest, infrastructureUnitGetRequest },
		} = this.props;
	...
	private handleFaramValidationSuccess = (faramValues: FaramValues) => {
		...
		const {
			requests: { addInfrastructureLossRequest },
			// onUpdate,
		} = this.props;

		const { serviceDisrupted: id } = faramValues;
        ...
        */
		...
		return (
			<Faram
				...
				<TextInput faramElementName="title" label="Title" autoFocus />
				<SelectInput
				...
				<SelectInput
					...
					labelSelector={labelSelector}
				/>
				<NumberInput faramElementName="equipmentValue" label="Equipment Value" />
				<NumberInput faramElementName="infrastructureValue" label="Infrastructure Value" />
				...
				<SelectInput
					...
					labelSelector={labelSelector}
				/>
				<NumberInput faramElementName="count" label="Count" />
