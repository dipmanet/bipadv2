...
import { setCountryListAction } from "#actionCreators";
						...
						<Faram
							...
							<ModalBody className={styles.modalBody}>
								...
								<SelectInput
									...
									autoFocus
								/>
								<TextInput faramElementName="name" label={t("Name")} />
								<NumberInput faramElementName="age" label={t("Age")} />
								<SelectInput
									placeholder={language === "en" ? "Select an option" : "विकल्प चयन गर्नुहोस्"}
									...
									labelSelector={labelSelector}
								/>
								<Checkbox faramElementName="belowPoverty" label={t("Below Poverty")} />
