				...
				{(t) => (
					<div className={_cs(styles.general, className)}>
						...
						<TextArea
							...
							autoFocus
						/>
						<TextArea className={styles.input} faramElementName="cause" label={t("Cause")} />
						...
						<div className={styles.inputGroup}>
							...
							<DateInput
								...
								language={language}
							/>
							<TimeInput className={styles.input} faramElementName="reportedOnTime" />
						</div>
						<div className={styles.inputGroup}>
...
export default compose(connect(mapStateToProps))(GeneralIncidentDetails);
