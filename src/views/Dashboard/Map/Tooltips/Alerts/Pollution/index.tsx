			...
			<div className={styles.content}>
				<div className={styles.aqi}>
					<div className={styles.title}>
						<Translation>{(t) => <span className={styles.value}>{t("AQI")}</span>}</Translation>:
					</div>
					<div className={styles.value}>{aqi ? aqi.toFixed(2) : "N/A"}</div>
				</div>
				<div className={styles.remark}>
					<div className={styles.title}>
						<Translation>{(t) => <span className={styles.value}>{t("Remark")}</span>}</Translation>
					</div>
					:
					<Translation>
