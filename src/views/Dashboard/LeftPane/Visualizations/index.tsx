			...
			<div className={styles.hazardStatisticsChart}>
				<header className={styles.header}>
					<h4 className={styles.heading}>
						<Translation>{(t) => <span>{t("Hazard Occurence Statistics")}</span>}</Translation>
					</h4>
					<Button
				...
				<div className={styles.alertSummary}>
					<header className={styles.header}>
						<h3 className={styles.heading}>
							<Translation>{(t) => <span>{t("Number of Alerts")}</span>}</Translation>
						</h3>
					</header>
						...
						{hazardSummary.map((s, idx) => (
							<div key={s.label} className={styles.summaryItem}>
								<div className={styles.label}>
									<Translation>{(t) => <span>{t(s.label)}</span>}</Translation>
								</div>
