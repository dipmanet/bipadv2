...
const mapDispatchToProps = (dispatch: Redux.Dispatch): PropsFromDispatch => ({
  ...
  setDashboardHazardTypes: (params) =>
    dispatch(setDashboardHazardTypesAction(params)),
...
const transformDataRangeToFilter = (
  ...
  const getFilter = (startDate?: Date, endDate?: Date) => ({
    ...
    [start]: startDate
      ? `${startDate.toISOString().split("T")[0]}T00:00:00+05:45`
      : undefined,
    // eslint-disable-next-line @typescript-eslint/camelcase
    // [end]: endDate ? endDate.toISOString() : undefined,
    [end]: endDate
      ? `${endDate.toISOString().split("T")[0]}T23:59:59+05:45`
      : undefined,
  });
...
class Dashboard extends React.PureComponent<Props, State> {
  ...
  public render() {
    ...
    const filteredHazardTypes = this.getAlertHazardTypesList(
      alertList,
      eventList
    );
    ...
    const alertMapHoverAttributes =
      this.getAlertMapHoverAttributes(hoveredAlertId);
    const eventMapHoverAttributes =
      this.getEventMapHoverAttributes(hoveredEventId);
    ...
    return (
      <>
        ...
        <Page
          ...
          mainContentContainerClassName={_cs(
            styles.hazardLegendContainer,
