    ...
    public render() {
        ...
        return (
            <div className={styles.vrSideBar}>
                ...
                can also be used for evacuation during floods. However, their functionality
                during floods are contingent upon several factors including building types
                and their exposure, whether they are located in flood prone or flood safe areas.
