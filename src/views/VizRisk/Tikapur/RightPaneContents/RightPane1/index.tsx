	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					Tikapur Municipality is located in the Kailali district of Sudurpaschim province. Tikapur
					municipality has a total area of 118 sq. km and is situated at an elevation of 145m to
					161m MASL.
				</p>
				<h2>Climate</h2>
				<p>
					Tikapur experiences a lower tropical climate. Summer starts from March and lasts till
					June. Winter begins in November and lasts till February. Tikapur faces heavy downpours
