	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				<h1>Land Cover</h1>
				<p>
					Out of a total area of 118 sq. km, 63.3% of the land is used for agriculture. Forests
					cover 12.6%, water bodies cover 5.2% and buildings cover 1.4% of the land area. Other
					areas in Tikapur are covered by sand, meadow, and shrubs.
				</p>
							...
							<Label
								...
								content={
									<CustomLabel
										...
										value2={` / ${((data[activeIndex].value / 118.022) * 100).toFixed(2)}%`}
									/>
								}
							/>
						</Pie>
