	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					Tikapur is surrounded by the Karnali river in the east, Janaki Rural Municipality in the
					north, Mohana River and Indian border in the south, and Bhajani Municipality in the west.
					The Karnali river flows to the Terai plains from a narrow gorge at Chisapani, where it
					bifurcates into Geruwa and Karnali rivers.
				</p>
				<p>
					All of the residential and governmental buildings, religious and cultural sites, banking
					institutions, critical infrastructures such as hospitals, schools, bridges in Tikapur are
