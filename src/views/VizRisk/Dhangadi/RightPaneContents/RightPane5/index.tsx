    ...
    public render() {
        ...
        return (
            <div className={styles.vrSideBar}>
                ...
                <p>
                This visualization helps understand the population, elements, and assets that
                are at threat to modeled flood hazards in the region. During the extreme flood,
                water cut across the ox-bows, damaging structures and fields, scouring the land,
