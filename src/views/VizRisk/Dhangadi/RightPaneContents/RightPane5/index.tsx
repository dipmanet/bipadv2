        ...
        return (
            <div className={styles.vrSideBar}>
                ...
                This visualization allows the superimposition of flood hazard maps for
                 the different return periods of flood with land use details.
                ...
                This visualization helps understand the population, elements,
                 and assets that are at threat to modeled flood hazards in the region.
                  During the extreme flood, water cut across the ox-bows, damaging structures
                   and fields, scouring the land, and depositing sediments.
                </p>
                <p>
                The impact of flooding can be greatly reduced through flood-sensitive
                land use planning and this visualization allows re-thinking
                 long-term spatial planning in the region.
                </p>
                {/* <SourceInfo /> */}
