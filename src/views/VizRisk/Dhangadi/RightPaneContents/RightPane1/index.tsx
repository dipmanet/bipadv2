	...
	public render() {
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					Dhangadhi Sub-Metropolitan City is in the Kailali district of Sudurpaschim province. It
					covers a total area of 260.92 sq. km and is located at an altitude of 109 MASL.
				</p>
				<h2>Climate</h2>
				<p>
					Summer starts in March and lasts till June. Winter begins in November and lasts till
					February. Dhangadhi faces heavy downpours during the monsoon, from June to October.
				</p>
