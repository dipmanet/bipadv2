		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					...
					following a flooding event. Currently there is one mapped safe shelter in Dhangadhi.
				</p>
				<p>
					The schools and cultural heritage sites can also be used for evacuation during floods.
					However, their functionality during floods are contingent upon several factors including
					building types and their exposure, whether they are located in flood prone or flood safe
					areas.
				</p>
				...
				<button className={styles.referencesBtn} type="button" onClick={this.handleRefClick}>
					References
				</button>
				{showReferences && (
					<ul className={styles.referencesText}>
						...
						<li>Dhangadhi Sub-Metropolitan City, 2021</li>
					</ul>
				)}
