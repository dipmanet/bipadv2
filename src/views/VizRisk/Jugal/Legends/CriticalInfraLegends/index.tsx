				...
				<div className={styles.criticalIcons}>
					<div className={styles.toggleContainer}>
						...
						<div className={styles.infraIconContainer}>
							<button
								type="button"
								className={showWater ? styles.criticalButtonSelected : styles.criticalButton}
								onClick={() => handleCriticalclick("Water sources")}>
								<ScalableVectorGraphics className={styles.svgIcon} src={Water} />
								Water Source
							</button>
						</div>
						...
						<div className={styles.infraIconContainer}>
							<button
								type="button"
								className={showTrade ? styles.criticalButtonSelected : styles.criticalButton}
								onClick={() =>
									handleCriticalclick("Trade and business (groceries, meat, textiles)")
								}>
								<ScalableVectorGraphics className={styles.svgIcon} src={Trade} />
								Trade and Business
							</button>
						</div>
					</div>
