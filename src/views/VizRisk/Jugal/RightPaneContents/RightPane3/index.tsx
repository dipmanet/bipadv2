	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				<h1>Demography</h1>
				<p>
					Population distribution in Jugal Rural Municipality is largely uneven with some pockets of
					dense settlements. The rural municipality has total population of 19,231 with 9581 male
					and 9650 female population residing in total 3941 households. Ward 2 has the largest
					household number with 731 households while ward 6 has the least number of households
					comprising of 378 households.
				</p>
				<div className={styles.chartContainer}>
					<ResponsiveContainer width="100%" height={500}>
						<BarChart
							...
							<Bar dataKey="MalePop" fill="#ffbf00" radius={[0, 10, 10, 0]} barSize={10} />
							<Bar dataKey="FemalePop" radius={[0, 10, 10, 0]} fill="#00d725" barSize={10} />
							<Bar dataKey="TotalHousehold" radius={[0, 10, 10, 0]} fill="#347eff" barSize={10} />
