...
class SlideFivePane extends React.PureComponent<Props, State> {
	...
	public componentDidMount() {
		...
		if (isDefined(CIData.features) && CIData.features.length > 0) {
			const chartDataTitlesUf = [...new Set(CIData.features.map((item) => item.properties.CI))];
				...
				{this.props.sesmicLayer === "ses" && (
					<>
						...
						<p>
							...
							visualization allows the super imposition of the seimic hazard map with details of
							landuse and critical infrastructures. The map shows the peak ground acceleration
							values due to earthquake ground shaking with 10% probability of exceedance in 50
							years.{" "}
						</p>
				...
				{this.props.sesmicLayer === "sus" && (
					<>
						...
						<p>
							...
							details of landuse and critical infrastructures. The map shows the relative indication
							of the probability of rainfall triggered landslides.
						</p>
