...
class SlideFourPane extends React.PureComponent<Props, State> {
	...
	public render() {
		...
		const { hazardTitle, chartData, fullhazardTitle, nonZeroArr } = this.state;
				...
				{chartData.length > 0 && (
					<>
						...
						<p>
							...
							{this.getDescription()}
							have been reported in Jugal Rural Municipality. These incidents have caused{" "}
							{incidentDetailsData.peopleDeathCount} deaths and{" "}
