		...
		if (active && payload && payload.length) {
			return (
				<div className={styles.customTooltip}>
					<p>{`${((payload[0].value / 595.94) * 100).toFixed(2)} % `}</p>
				</div>
			);
		}
		return null;
	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				<h1>Land Cover</h1>
				<p>
					Out of a total area of 595.94 square km, 34.08% of the land is covered by forests, 9.1% by
					glaciers, 8.5% by farmland and scree. Other areas in the rural municipality is covered by
					builtup area, meadow, grassland, water bodies, scrub, fell and other uncategorized areas
					in OpenStreetMap.
				</p>
