					...
					<>
						{showAddForm ? (
							<HouseholdForm
								...
								appendBuildingData={this.props.appendBuildingData}
							/>
						) : (
							<>
								<h1>
						...
						<div className={styles.buildingClassContainer}>
							<div className={styles.levelContainer}>
								...
								<div className={styles.iconLevel}>
									<Icon name="home" className={styles.high} />
							...
							<div className={styles.levelContainer}>
								<span>Medium</span>
								<div className={styles.iconLevel}>
									<Icon name="home" className={styles.med} />
							...
							<div className={styles.levelContainer}>
								<span>Low</span>
								<div className={styles.iconLevel}>
									<Icon name="home" className={styles.low} />
