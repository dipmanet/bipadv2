	...
	public componentDidMount() {
		...
		if (isDefined(criticalinfrastructures.features)) {
			const categoriesCriticalArr = [
				...new Set(criticalinfrastructures.features.map((item) => item.properties.CI)),
			];
	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					Community Infrastructures are socially, economically or operationally essential to the
					functioning of a society or community, both in routine circumstances and in the extreme
					circumstances of an emergency.
				</p>
				<p>
					All of the residential and governmental buildings, religious and cultural sites, financial
					institutions, critical infrastructures such as hospitals, schools, bridges in the
					municipality are at constant threat to various hazards every year.
				</p>
