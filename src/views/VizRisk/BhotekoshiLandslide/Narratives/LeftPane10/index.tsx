...
const LeftPane10 = (props: Props) => {
	...
	const { drawData, landSlide, chartReset, ci, pending, buildingCount, overallBuildingsCount } =
		props;
	...
	return (
		<div className={styles.vrSideBar}>
			...
			<p className={styles.narrativeText}>
				The map shows the ward level risk of landslide in Bhotekoshi Rural Municipality. The
				municipality lies in hilly region of the country, highly susceptible to landslides. Out of
				the 5 wards, ward 1 and 3 posess higher risk of landslide.
			</p>
