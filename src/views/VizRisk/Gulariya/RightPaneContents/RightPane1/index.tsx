    ...
    public render() {
        ...
        return (
            <div className={styles.vrSideBar}>
                ...
                <p>
                Gulariya municipality lies in the Terai region of Bardiya
                district in Lumbini Province. It covers a total area of 118
                sq. km and is situated at an elevation of 145m from sea level.
                </p>
                <h2>Climate</h2>
                <p>
                Gulariya experiences a subtropical climate. Summer starts in March
                and lasts till June. Winter begins in November (Mangsir) and lasts
                till February. Gulariya faces heavy downpours during the monsoon,
