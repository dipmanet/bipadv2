	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					Out of a total area of 118 sq. km, 72.4% of the land is covered by farmland, 6.4% by
					forests. Other areas are covered by water bodies, grassland, sand, and built-up area.
				</p>
							...
							<Label
								...
								content={
									<CustomLabel
										...
										value2={` / ${((data[activeIndex].value / 117.949) * 100).toFixed(2)}%`}
									/>
								}
							/>
						</Pie>
