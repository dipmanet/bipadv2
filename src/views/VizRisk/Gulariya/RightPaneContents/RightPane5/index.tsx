	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					This visualization allows the superimposition of the flood hazard maps for a different
					return period of flood with land use details. Return period is the probability of
