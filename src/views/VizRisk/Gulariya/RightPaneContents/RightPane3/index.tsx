	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				<h1>Demography</h1>
				<p>
					Dense settlements exist in some of the core urban areas, especially in ward 4. Most of the
					region comprises mostly peri-urban and rural settlements with a low density of population.
				</p>
				<p>
					Gulariya Municipality has a total population of 71,991. Ward number 4 has the highest
					population with 1786 families. Ward number 5 has the least population (4335) with 782
					families.
				</p>
