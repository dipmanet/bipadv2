...
const FloodHistoryLegends = (props: Props) => {
	...
	const { handleFloodChange, setfloodLayer, hazardLegendClickedArr } = props;
		...
		<>
			{hazardLegendClickedArr[0] === 1 && (
				<div className={styles.legendContainer}>
					<button type="button" className={styles.toggleFlood} onClick={handleFloodChange}>
						<h2>
							Flood Hazard
							<br />
							in Return Period
					...
					<div className={styles.floodMainContainer}>
						...
						<div className={styles.floodItemContainer}>
							<button
								type="button"
								className={
									activeRasterLayer === "100" ? styles.legendBtnSelected : styles.legendBtn
								}
						...
						<div className={styles.floodItemContainer}>
							<button
								type="button"
								className={
									activeRasterLayer === "200" ? styles.legendBtnSelected : styles.legendBtn
								}
						...
						<div className={styles.floodItemContainer}>
							<button
								type="button"
								className={
									activeRasterLayer === "250" ? styles.legendBtnSelected : styles.legendBtn
								}
						...
						<div className={styles.floodItemContainer}>
							<button
								type="button"
								className={
									activeRasterLayer === "500" ? styles.legendBtnSelected : styles.legendBtn
								}
						...
						<div className={styles.floodItemContainer}>
							<button
								type="button"
								className={
									activeRasterLayer === "1000" ? styles.legendBtnSelected : styles.legendBtn
								}
