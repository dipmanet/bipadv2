...
&& lossDataFlood.length > 0 && lossDataLandslide.length > 0
&& demographicData.length > 0 && earthquakeData.length > 0) {
                setpending(false);
            }
        }
    }, [cI,
    ...
    const handleMultipeLegendClicked = (legendClicked: string, i: number) => {
        ...
        } else if (clickedCur[3] === 1 && (clickedCur[0] === 1 || clickedCur[2] === 1 || clickedCur[1] === 1)) {
            clickedCur[3] = 0;
            setclicked(clickedCur);
        } else {
            setclicked(clickedCur);
...
&& curExposure[2] === 1 && curExposure[3] === 1 && curExposure[4] === 1) {
    ...
    }, [alertsGetRequest, cIGetRequest, climateDataRequest, contactGetRequest, damageandLossDataFlood, damageandLossDataLandslide, demographyRequest, earthquakeDataRequest, htmlRequest, jsonDataRequest, precipitationDataGetRequest, tempDataGetRequest, vulnerabilityGetRequest]);
    ...
    const page1TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page1_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page1Legend1TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page1_legend1_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page1Legend2TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page1_legend2_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page1Legend3TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page1_legend3_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page2TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page2_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page3TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page3_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page3Legend1Introhtml = htmlData.filter(item => item.key === `${KEYNAME}_page3_legend1_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page3Legend2Introhtml = htmlData.filter(item => item.key === `${KEYNAME}_page3_legend2_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page3Legend3Introhtml = htmlData.filter(item => item.key === `${KEYNAME}_page3_legend3_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page3Legend4Introhtml = htmlData.filter(item => item.key === `${KEYNAME}_page3_legend4_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page4TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page4_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page4Legend1Introhtml = htmlData.filter(item => item.key === `${KEYNAME}_page4_legend1_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page4Legend2Introhtml = htmlData.filter(item => item.key === `${KEYNAME}_page4_legend2_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page4Legend3Introhtml = htmlData.filter(item => item.key === `${KEYNAME}_page4_legend3_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page5TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page5_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page6TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page6_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const page7TopIntrohtml = htmlData.filter(item => item.key === `${KEYNAME}_page7_top_introhtml_${THEME_ID}_${SUFFIXID}`).map(item => item.value);
    ...
    const page1Legend2MidLandcoverData = jsonData.filter(item => item.key === `${KEYNAME}_page1_legend2_mid_landcoverdata_${THEME_ID}_${SUFFIXID}`).map(item => item.value);
    ...
    const populationGridData = jsonData.filter(item => item.key === `${KEYNAME}_population_grid_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const populationDensityRange = jsonData.filter(item => item.key === `${KEYNAME}_population_density_range_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const satelliteImageYears = jsonData.filter(item => item.key === `${KEYNAME}_satellite_image_year_layer_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const floodHazardLayers = jsonData.filter(item => item.key === `${KEYNAME}_flood_hazard_layers_${THEME_ID}_${SUFFIXID}`).map(item => item.value);

    const buildingCountData = jsonData.filter(item => item.key === `${KEYNAME}_building_count_${THEME_ID}_${SUFFIXID}`).map(item => item.value);
    ...
    useEffect(() => {
        ...
        climateDataRequest.do();
    }, [climateDataRequest, realTimeDataStationName]);
    ...
    if (alertsName && alertsName.length > 0) {
        ...
        for (let index = 0; index < alertsName.length; index++) {
            ...
            const mainAlert = {
                name: alertsName[index] ? alertsName[index].charAt(0).toUpperCase() + alertsName[index].slice(1) : 'No data',
                count: realData,
