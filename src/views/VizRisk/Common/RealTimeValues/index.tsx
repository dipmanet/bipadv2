...
const RealTimeValues = (props: Props) => {
	const {
		...
		pollutionStName,
		hideWaterLevel,
		requests: { rainRequest, waterLevelReq, pollutionReq },
	} = props;
		...
		<>
			<div className={styles.iconRow}>
				<div className={styles.infoIconsContainer}>
					...
					<div className={styles.descriptionCotainer}>
						...
						<div className={styles.iconText}>Temperature (Real Time)</div>
					</div>
				</div>
				{!hideWaterLevel && (
					<div className={styles.infoIconsContainer}>
						<ScalableVectorGraphics className={styles.infoIcon} src={WaterLevel} />
						<div className={styles.descriptionCotainer}>
							<div className={styles.iconTitle}>{`${waterLevel} mm`}</div>
							<div className={styles.iconText}>Water Level</div>
						</div>
					</div>
				)}
			</div>
			<div className={styles.iconRow}>
				<div className={styles.infoIconsContainer}>
					...
					<div className={styles.descriptionCotainer}>
						<div className={styles.iconTitle}>{rainFall} mm</div>
						<div className={styles.iconText}>Rainfall (24 Hrs)</div>
					</div>
				</div>
			</div>
		</>
