...
const NavButtons = (props: Props) => {
	const { handleNext, handlePrev, pagenumber, totalPages, pending, idle } = props;
		...
		<div className={styles.navRow}>
			<div className={styles.pageIndicator}>
				...
				<span className={styles.currentPageColor}>
					{pagenumber === 1 && "1"}
					{pagenumber === 2 && "1"}
					{pagenumber !== 2 && pagenumber !== 1 && pagenumber - 1}
				</span>
				{"/"}
				<span className={styles.totPages}>{totalPages - 1}</span>
			</div>
			<div className={styles.navBtnCont}>
				<button
					...
					onClick={handlePrev}
					className={
						pagenumber === 1 || pending === true || idle === false
							? styles.btnDisable
							: styles.navbutton
					}
				...
				<button
					...
					onClick={handleNext}
					className={
						pagenumber === totalPages || pending === true || idle === false
							? styles.btnDisable
							: styles.navbutton
					}
