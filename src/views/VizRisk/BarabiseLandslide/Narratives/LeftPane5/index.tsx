	...
	return (
		<div className={styles.vrSideBar}>
			...
			<p className={styles.narrativeText}>
				Barhabise municipality has a total population of 26,114 with 13257 males and 128537 females
				residing in a total of 7660 households. Ward 3 has the largest number of households (1195)
				while ward 1 has the least number of households (310).
			</p>
