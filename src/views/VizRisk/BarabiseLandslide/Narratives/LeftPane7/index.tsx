	...
	return (
		<div className={styles.vrSideBar}>
			...
			<p className={styles.narrativeText}>
				In the year 2020, 3 landslide incidents have occurred in the municipality. 8 people lost
				their lives, 32 went missing and 47 houses were destroyed.
			</p>

			<p>NO. OF INCIDENTS</p>
			<div className={styles.climateChart}>
				<ResponsiveContainer width={"100%"} height={"100%"}>
					<BarChart data={incidentChart} layout="vertical" margin={{ left: 20, right: 20 }}>
