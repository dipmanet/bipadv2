	...
	return (
		<div className={styles.vrSideBar}>
			...
			<p className={styles.narrativeText}>
				The map shows the area of Barhabise Municipality where landslides are likely to occur. The
				red color signifies the higher likelihood and blue color signifies the lower likelihood of
