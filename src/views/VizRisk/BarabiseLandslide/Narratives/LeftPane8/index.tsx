	...
	return (
		<div className={styles.vrSideBar}>
			...
			<p className={styles.narrativeText}>
				...
				visualizing if and how they have changed.
			</p>
			<p className={styles.narrativeText}>
				After Gorkha Earthquake 2015, 451 landslide incidents were observed in the post monsoon
				season. Likewise, the higher number of post monsoon landslide incidents until date occurred
				in 2020 i.e. 543.
			</p>
			...
			<div className={styles.climateChart}>
				<ResponsiveContainer width={"100%"} height={wardwiseChartData.length * 40 + 60}>
					<BarChart data={wardwiseChartData} layout="vertical" margin={{ left: 0, right: 10 }}>
						<CartesianGrid strokeDasharray="3 3" />
						<XAxis type="number" />
						<YAxis type="category" dataKey="name" tick={{ fill: "#94bdcf" }} />
						<Tooltip />
