	...
	return (
		<div className={styles.vrSideBar}>
			...
			<p className={styles.narrativeText}>
				Out of a total area of 134.65 square km, 63.13 sq km of the land is covered by forests,
				23.64 sq km by farmland, 13.8 sq km by meadow, 0.112 sq km by water bodies and 8.6 sq km by
				residential areas. Other areas in the municipality is covered by scree, sand, scrubs,
				shingles and stones.
			</p>
