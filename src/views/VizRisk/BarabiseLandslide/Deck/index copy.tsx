...
import testData from '../Data/librariesData';
...
const Deck = (props) => {
    ...
    const data = testData.librariesData.map(row => ({
        timestamp: row.date,
                                ...
                                {glContext && (
                                    <StaticMap
                                        ...
                                        mapStyle={
                                            ...
                                            'mapbox://styles/yilab/ckmfsdj493kul17p0gd0el1ig'
                                        }
                                        mapboxApiAccessToken={
                                            // process.env.REACT_APP_MAPBOX_ACCESS_TOKEN
                                            'pk.eyJ1IjoieWlsYWIiLCJhIjoiY2tiN2oxY295MDY4aDJwdXNwNTAyN3oxdCJ9.TXPDk1t0JXGzTz665bhPdA'
                                        }
                                        onLoad={onMapLoad}
                                    />
                                )}
                            </DeckGL>
                            {timeRange && allDataVisible
                                ? (
                                    <RangeInput
                                        min={timeRange[0]}
                                        max={timeRange[1]}
