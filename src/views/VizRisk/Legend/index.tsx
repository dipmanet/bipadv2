...
import { legendOptions, chapterLayers } from '../config';
...
const Legend = (props) => {
    ...
    if (legend.range) {
        ...
        //  className={classes.labelStyle}>{legend.name}</Typography>
        //     <ul>
        //         <li className="min">
        ...
        //                 <div style={{ width:
        // '100%', background: `linear-gradient(to right, ${legend.colors.join(',')})` }} />
        //             </div>
        //         </li>
        //     </ul>
        // </Paper>
