						...
						<div className={styles.populationContainer}>
							...
							<div className={styles.populationTextContainer}>
								<div className={styles.populationText}>{`${parseStringToNumber(
									intervals[3]
								)} - ${parseStringToNumber(intervals[4])}`}</div>
								<div className={styles.populationText}>{`${parseStringToNumber(
									intervals[2]
								)} - ${parseStringToNumber(intervals[3])}`}</div>
								<div className={styles.populationText}>{`${parseStringToNumber(
									intervals[1]
								)} - ${parseStringToNumber(intervals[2])}`}</div>
								<div className={styles.populationText}>{`${parseStringToNumber(
									intervals[0]
								)} - ${parseStringToNumber(intervals[1])}`}</div>
								<div className={styles.populationText}>{`${minPop}- ${parseStringToNumber(
									intervals[0]
								)}`}</div>
							</div>
						</div>
