...
const VizRiskMainPage = (props: Props) => {
	...
	const renderVizRisk = () => {
		switch (clickedVizrisk) {
			case "Butwal":
				return <Butwal municipalityId={49001} munThemeId={101} />;
			case "Ratnanagar":
				return <Ratnanagar />;
			case "Jugal":
				return <Jugal />;
			...
			case "Panchpokhari":
				return <Panchpokhari />;
			case "Janakpur":
				return <Butwal municipalityId={17010} munThemeId={101} />;
			case "Bhotekoshi":
				return <Bhotekoshi />;
			case "Barhabise":
				return <Barabise />;
	...
	const {
		requests: { vizRiskThemeIdRequest },
	} = props;
				...
				{!showMenu && (
					<div className={styles.hamburgerBtnContainer}>
						<Button
							...
							<Icon name="menu" className={styles.hamburgerBtnIcon} />
							{!showMenu && (
								<>
