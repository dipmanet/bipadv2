            ...
            {showPopulationWard
                ? (
                    ...
                    <div>
                        ...
                        <div className={styles.populationContainer}>
                            <div className={styles.populationIndContainer}>
                                <div className={styles.populationDenIndicator1} />
                                <div className={styles.populationDenIndicator2} />
                                <div className={styles.populationDenIndicator3} />
                                <div className={styles.populationDenIndicator4} />
                                <div className={styles.populationDenIndicator5} />
                            </div>
                            <div className={styles.populationTextContainer}>
