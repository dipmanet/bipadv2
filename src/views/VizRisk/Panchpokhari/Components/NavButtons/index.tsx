	...
	return (
		<div className={styles.navRow}>
			<div className={styles.pageIndicator}>
				Showing
				<span className={styles.currentPageColor}>{pagenumber}</span>
				{"/"}
				<span className={styles.totPages}>{totalPages}</span>
			</div>
			<div className={styles.navBtnCont}>
				...
				<button
					...
					onClick={handleNext}
					className={
						pagenumber === totalPages || pending === true ? styles.btnDisable : styles.navbutton
					}
