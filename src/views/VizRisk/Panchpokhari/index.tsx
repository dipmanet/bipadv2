...
class Jugal extends React.Component {
	...
	public componentDidUpdate() {
		...
		if (pending) {
			if (vulData.length > 0 && buildings.length > 0 && cI.length > 0 && enumData.length > 0) {
	...
	public render() {
		...
		const { incidentList, regions, hazardTypes, hazards } = this.props;
			...
			<div>
				...
				{rightElement === 1 ? (
					<div className={styles.legends}>
						<VRLegend>
							<DemographicsLegends handlePopulationChange={this.handlePopulationChange} />
						</VRLegend>
					</div>
				) : (
					""
				...
				{rightElement === 5 && (
					<>
						...
						/>
						<VRLegend>
							<SesmicHazardLegend handleSesmicLayerChange={this.handleSesmicLayerChange} />
						</VRLegend>
						{
							// here
							sesmicLayer === "flood" && (
								<FloodHazardlegends handleFloodChange={this.handleFloodChange} />
							)
						}
					</>
				)}
				{rightElement === 6 && (
					<>
						...
						/>
						<VRLegend>
							<SesmicHazardVULLegend handleSesmicLayerChange={this.handleSesmicLayerChangeVUL} />
						</VRLegend>
						{
							// here
