	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					Panchpokhari Thangpal Rural Municipality is located in the Sindhupalchok district of
					Bagmati Province. It covers a total area of 187.29 sq km and is situated at an elevation
				...
				<p style={{ fontSize: "16px", marginBottom: "0px", marginTop: "30px", fontWeight: "bold" }}>
					{" "}
					Temperature
				</p>
