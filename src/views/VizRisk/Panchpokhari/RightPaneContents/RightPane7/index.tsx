			...
			<div className={styles.vrSideBar}>
				...
				{singularBuilding && (
					<>
                     ...
                     score was not calculated are being displayed in black.">
								...
								<p>
									The physical, social and economic fators were considered to identify the
								...
								<table className={styles.singularPaneTable}>
									<tr>
										...
										<td>{(singularBuldingData && singularBuldingData.foundationType) || "-"}</td>
									</tr>
									<tr>
										<td>Roof Type</td>
										<td>{(singularBuldingData && singularBuldingData.roofType) || "-"}</td>
									</tr>
									<tr>
										<td>Storey</td>
										<td>{(singularBuldingData && singularBuldingData.storeys) || "-"}</td>
									</tr>
									<tr>
										<td>Ground surface</td>
										<td>{(singularBuldingData && singularBuldingData.groundSurface) || "-"}</td>
									</tr>
									<tr>
										<td>Building condition</td>
										<td>{(singularBuldingData && singularBuldingData.buildingCondition) || "-"}</td>
									</tr>
									<tr>
										<td>Damage Grade</td>
										<td>{(singularBuldingData && singularBuldingData.damageGrade) || "-"}</td>
									</tr>
									<tr>
										<td>Distance from road (meter)</td>
										<td>{(singularBuldingData && singularBuldingData.roadDistance) || "-"}</td>
									</tr>
									<tr>
										<td>Drinking water distance (minutes)</td>
										<td>
								...
								<table className={styles.singularPaneTable}>
									...
									<tr>
										...
										<td>{(singularBuldingData && singularBuldingData.ownership) || "-"}</td>
									</tr>
									<tr>
										<td>People with disability</td>
										<td>
											{(singularBuldingData && singularBuldingData.peopleWithDisability) || "-"}
										</td>
									</tr>
									<tr>
										<td>Distance from Medical centers (minutes)</td>
										<td>
											{(singularBuldingData && singularBuldingData.healthPostDistance) || "-"}
										</td>
									</tr>
									<tr>
										<td>Distance from Security centers (minutes)</td>
										<td>
											{(singularBuldingData && singularBuldingData.policeStationDistance) || "-"}
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											{(singularBuldingData && singularBuldingData.openSafeSpaceDistance) || "-"}
										</td>
									</tr>
								</table>
								<p>Agewise Population Distribution</p>
								...
								<table className={styles.singularPaneTable}>
									<tr>
										...
										<td> {(singularBuldingData && singularBuldingData.majorOccupation) || "-"} </td>
									</tr>
									<tr>
								...
								<div className={styles.backBtnContainer}>
									<button onClick={this.handleBackBtn} type="button" className={styles.backButton}>
										Back
									</button>
								</div>
							</>
				...
				{!singularBuilding && (
					<>
						...
						<div className={styles.buildingClassContainer}>
							<div className={styles.levelContainer}>
								...
								<div className={styles.iconLevel}>
									<Icon name="circle" className={styles.high} />
									<span className={styles.number}> {buildingVulnerability.high} </span>
								</div>
							</div>
							<div className={styles.levelContainer}>
								<span>Medium</span>
								<div className={styles.iconLevel}>
									<Icon name="circle" className={styles.med} />
									<span className={styles.number}> {buildingVulnerability.medium} </span>
								</div>
							</div>
							<div className={styles.levelContainer}>
								<span>Low</span>
								<div className={styles.iconLevel}>
									<Icon name="circle" className={styles.low} />
									<span className={styles.number}> {buildingVulnerability.low} </span>
								</div>
							</div>
							<div className={styles.levelContainer}>
								<span>No Score</span>
								<div className={styles.iconLevel}>
									<Icon name="circle" className={styles.noscore} />
									<span className={styles.number}> {buildingVulnerability.noscore} </span>
								</div>
							</div>
						</div>
						<p>PHYSICAL, SOCIAL AND ECONOMIC FACTORS</p>
						<p>Foundation type of the buildings</p>
						...
						<p>Population distribution in the households</p>
