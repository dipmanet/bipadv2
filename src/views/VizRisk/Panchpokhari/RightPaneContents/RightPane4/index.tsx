	...
	public render() {
		...
		return (
			<div className={styles.vrSideBar}>
				...
				<p>
					Critical Infrastructures are crucial even during the time of crisis. The residential and
					governmental buildings, religious and cultural sites, banking institutions, as well as
					critical infrastructures such as hospitals, schools, bridges in the municipality are at
