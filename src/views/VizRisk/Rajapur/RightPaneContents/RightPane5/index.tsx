    ...
    public render() {
        ...
        return (
            <div className={styles.vrSideBar}>
                ...
                maps for different return periods of flood with land use details.
                ...
                that are at threat to modeled flood hazards in the region. For instance,
                the dense settlement areas that are in proximity to the Karnali river,
                on either tributary and lying in the high flood depth might face major
                human and economic loss in future floods.
                </p>
                <p>
                The impact of flooding can be greatly reduced through flood-sensitive land use
