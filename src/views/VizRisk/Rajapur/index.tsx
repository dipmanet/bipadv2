...
class Rajapur extends React.Component {
	public constructor(props) {
		...
		const {
			requests: { cIGetRequest, rainRequest, waterLevelReq, pollutionReq },
		} = this.props;
			...
			<div>
				{
					<div className={styles.navBtnCont}>
						<button
							...
							<Icon
								name="chevronLeft"
								className={disableNavLeftBtn ? styles.btnDisable : styles.nextPrevBtn}
							/>
						</button>
						<button
							type="button"
							...
							<Icon
								name="chevronRight"
								className={disableNavRightBtn ? styles.btnDisable : styles.nextPrevBtn}
							/>
						</button>
					</div>
				}
				...
				{rightElement === 0 && (
					<RightElement1 rainFall={rainFall} waterLevel={waterLevel} temperature={temperature} />
				)}
				{rightElement === 1 ? (
				...
				{rightElement === 3 ? (
					<>
						{cI.features && cI.features.length > 0 && <RightElement4 criticalInfraData={cI} />},
						<div className={styles.legends}>
							<VRLegend>
				...
				{rightElement === 5 ? (
					<div className={styles.legends}>
						<VRLegend>
							<EvacLegends handleEvac={this.handleEvac} evacElement={evacElement} />
						</VRLegend>
						<VRLegend>
							<FloodHazardLegends
								handleFloodChange={this.handleFloodChange}
