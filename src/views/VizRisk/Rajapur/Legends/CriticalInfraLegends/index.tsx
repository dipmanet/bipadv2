...
const LandCoverLegends = (props) => {
	const { handleCritical, criticalFlood, showBuildingPoints, criticalInfraData } = props;
					...
					<div className={styles.toggleContainer}>
						...
						<div className={styles.infraIconContainer}>
							<button
								type="button"
								className={
									showCommunication ? styles.criticalButtonSelected : styles.criticalButton
								}
								onClick={() => handleCriticalclick("Communication")}>
								<ScalableVectorGraphics className={styles.svgIcon} src={Communication} />
								Communication
							</button>
						</div>
						<div className={styles.infraIconContainer}>
							<button
								type="button"
								className={showBank ? styles.criticalButtonSelected : styles.criticalButton}
						...
						<div className={styles.infraIconContainer}>
							<button
								type="button"
								className={showIndustry ? styles.criticalButtonSelected : styles.criticalButton}
								onClick={() => handleCriticalclick("Industry")}>
								<ScalableVectorGraphics className={styles.svgIcon} src={Industry} />
								Industry
							</button>
						</div>
						<div className={styles.infraIconContainer}>
						...
						<div className={styles.infraIconContainer}>
							<button
								type="button"
								className={showElectricity ? styles.criticalButtonSelected : styles.criticalButton}
								onClick={() => handleCriticalclick("Electricity")}>
								<ScalableVectorGraphics className={styles.svgIcon} src={Electricity} />
								Electricity
							</button>
						</div>
						<div className={styles.infraIconContainer}>
							<button
								type="button"
								className={
									showTransportation ? styles.criticalButtonSelected : styles.criticalButton
								}
								onClick={() => handleCriticalclick("Transportation")}>
								<ScalableVectorGraphics className={styles.svgIcon} src={Transportation} />
								Transportation
							</button>
						</div>
						{showBuildingPoints && (
							<div className={styles.infraIconContainer}>
								<button
									type="button"
									className={showBuilding ? styles.criticalButtonSelected : styles.criticalButton}
