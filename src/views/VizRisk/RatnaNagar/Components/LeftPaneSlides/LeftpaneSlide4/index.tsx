...
const LeftpaneSlide5 = () => {
	const { keyValueHtmlData } = useContext(MainPageDataContext);
		...
		<div className={styles.vrSideBar}>
			<div className="mainTitleDiv">
				...
				<div>
					...
					<p>
						{" "}
						<span style={{ fontSize: 20, fontWeight: "bold" }}>1500 </span> Building
					</p>
					<p>
						{" "}
						<span style={{ fontSize: 20, fontWeight: "bold" }}> 27,719 m</span> of Roads
					</p>
					<p>
						<span style={{ fontSize: 20, fontWeight: "bold" }}>2.98 sq.km</span> of Agricultural
						Land
					</p>
				</div>
				<p>
					<em>Source: WFP, OpenSteetMap</em>
				</p>
			</div>
		</div>
	);
