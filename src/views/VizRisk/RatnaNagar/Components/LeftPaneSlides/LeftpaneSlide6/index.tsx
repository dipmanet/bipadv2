...
const LeftpaneSlide4 = () => {
	...
	const htmlDataTop =
		keyValueHtmlData &&
		getDataFromKey("vizrisk_ratnanagar", "page6_htmldata", "301_3_35_35007", keyValueHtmlData);
	...
	return (
		<div className={styles.vrSideBar}>
			...
			<p>
				The exposure scores range from 0 to 10 and are divided into 5 classes, each represented by a
				different color. The exposure value of the municipality is low ({averageExposureScore}
				/10). A large family size corresponds to more exposure. Likewise, materials used for
				building construction and the type of building itself represent varying degrees of exposure.
			</p>
