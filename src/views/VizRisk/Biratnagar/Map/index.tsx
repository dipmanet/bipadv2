...
const slideTwoLayers = ['bridgeBiratnagar', 'water', 'waterway',
    'canalBiratnagar', 'BiratnagarBuildings',
    'BiratnagarRoads', 'forestBiratnagar', 'IndustrialAreaBiratnagar ', 'CommercialAreaBiratnagar', 'WoodforestBiratnagar',
    'agriculturallandBiratnagar', 'agriculturallandFarmyardBiratnagar', 'municipalityFill',
...
class FloodHistoryMap extends React.Component {
    ...
    public componentDidMount() {
        ...
        this.map = new mapboxgl.Map({
            ...
            style: process.env.REACT_APP_VIZRISK_BIRATNAGAR_FLOOD,
            center: [lng, lat],
            zoom,
            minZoom: 2,
            maxZoom: 22,
        ...
        this.map.on('style.load', () => {
            ...
            this.map.addLayer({
                ...
                filter: getWardFilter(5, 65, 5002, wards),
            });
