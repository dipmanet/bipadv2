...
import { setProfileContactFiltersAction } from "#actionCreators";
...
import { profileContactFiltersSelector } from "#selectors";
	...
	render() {
		...
		return (
			<CollapsibleView
				...
				collapsedView={
					<PrimaryButton onClick={this.handleShowFiltersButtonClick} title="Show filters">
						Show Filters
					</PrimaryButton>
				}
