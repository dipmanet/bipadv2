	...
	handleSearch = (value) => {
		...
		if (value === "" || value === null) {
			...
			const filteredData = projects.filter(
				(item, i) => item.ptitle.toLowerCase().indexOf(value.toLowerCase()) !== -1
			);
		...
		const dataList =
			...
			splittedData.map((item) => {
				const individualItem = item.map((d) => {
					...
					const englishMonthConvertedFrom = englishMonth.find(
						(m) => m.id === splittedDateFrom[1]
					).month;
					const englishMonthConvertedTo = englishMonth.find(
						(m) => m.id === splittedDateTo[1]
					).month;
			...
			splittedData.map((item, i) => (
				<Translation>
					{(t) => (
						<div
							key={i}
							style={{ display: "flex", width: "100%", height: "220px", marginBottom: "60px" }}>
							<div
								className={
									i > mainColumnIndex
										? clickedColumn === "col1"
											...
											<div
												...
												<div
													...
													<div
														...
														<div style={{ display: "flex" }}>
															<div style={{ fontWeight: "bold" }}>{t("Organization")}:</div>
															<div
																style={{
																	marginLeft: "2px",
																	maxHeight: "35px",
												...
												<div className={styles.footer}>
													<div
														...
														<ScalableVectorGraphics className={styles.icon} src={dateCalender} />
														<div style={{ marginLeft: "5px" }}>{data.listViewDate}</div>
													</div>
												</div>
											</div>
										) : (
											...
											<div
												...
												<div
													...
													<div
														...
														<div style={{ display: "flex" }}>
															<div style={{ fontWeight: "bold" }}>{t("Budget")}:</div>
															<div style={{ marginLeft: "30px" }}>
																<span>USD {data.budget_usd}</span>
															</div>
														</div>
