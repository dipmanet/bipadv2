...
import { setProjectsProfileFiltersAction } from "#actionCreators";
import RegionSelectInput from "#components/RegionSelectInput";
import MultiSelectInput from "#rsci/MultiSelectInput";
import SelectInput from "#rsci/SelectInput";
import { languageSelector, projectsProfileFiltersSelector } from "#selectors";
...
class ProjectsProfileFilter extends React.PureComponent {
	...
	handleFaramChange = (faramValues, faramErrors) => {
		const { filters: { faramValues: oldFaramValues = emptyObject } = {} } = this.props;
	...
	render() {
		const {
			className,
			filters: { faramValues = emptyObject, faramErrors = emptyObject } = {},
