...
import { _cs, getHexFromString, isNotDefined, listToMap, mapToList } from "@togglecorp/fujs";
...
import { projectsProfileFiltersSelector, regionLevelSelector, regionsSelector } from "#selectors";
				...
				{(titleContext) => {
					...
					return (
						<React.Fragment>
							...
							<Map projects={filteredProjects} regions={regions} regionLevel={regionLevel} />
							<LeftPane
