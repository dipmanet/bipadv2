...
class Demographics extends React.PureComponent<Props> {
    ...
    private getHouseholdSummary = (data: SummaryData) => {
        ...
        return ([
            { key: 'totalPopulation', label: 'Total Population', value: totalPopulation, color: '#2A7BBB' },
            { key: 'householdCount', label: 'Household Count', value: householdCount, color: '#83A4D3' },
        ]);
    }
