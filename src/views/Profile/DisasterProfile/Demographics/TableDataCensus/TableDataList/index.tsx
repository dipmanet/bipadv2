                    ...
                    >
                        {selectedCategory === 1 ? (
                            ...
                            >
                                <thead>
                                    <tr>
                                        <th colSpan="5" scope="colgroup" style={{ textAlign: 'center' }}>{t('Population')}</th>
                                    </tr>
                                    <tr>
                            ...
                            selectedCategory === 2
                                ? (
                                    ...
                                    >
                                        <thead>
                                            <tr>
                                                <th colSpan="4" scope="colgroup" style={{ textAlign: 'center' }}>{t('Population By Age Group')}</th>
                                            </tr>
                                            <tr>
                        ...
                        {selectedCategory === 3 ? (
                            ...
                            >
                                <thead>
                                    <tr>
                                        <th colSpan={literacy.length} scope="colgroup" style={{ textAlign: 'center' }}>{t('Literacy Rate')}</th>
                                    </tr>
                                    <tr>
                                        {literacy.map(item => (
