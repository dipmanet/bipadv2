							...
							<div className={styles.profileMainDiv}>
								...
								<div className={styles.profileList}>
									...
									<div
										...
										<h1>{t("Projects")}</h1>
										<div style={{ fontSize: "50px" }}>
											<Icon className={styles.visualizationIcon} name="briefcase" />
										</div>
									</div>
									<div
										className={styles.profileListContent}
										...
										<h1>{t("Contacts")}</h1>
										<div style={{ fontSize: "50px" }}>
											<Icon className={styles.visualizationIcon} name="contacts" />
										</div>
									</div>
									<div
										className={styles.profileListContent}
										...
										<h1>{t("Documents")}</h1>
										<div style={{ fontSize: "50px" }}>
											<Icon className={styles.visualizationIcon} name="document" />
										</div>
									</div>
									<div
										className={styles.profileListContent}
