...
const TourismFields: FunctionComponent = ({
	faramValues,
	optionsClassName,
	iconName,
	language: { language },
	...
	return (
		<Translation>
			{(t) => (
				<>
					<NumberInput faramElementName="noOfRoom" label={t("Number of rooms")} />
					<NumberInput faramElementName="noOfBed" label={t("Number of beds")} />
...
export default connect(mapStateToProps)(TourismFields);
