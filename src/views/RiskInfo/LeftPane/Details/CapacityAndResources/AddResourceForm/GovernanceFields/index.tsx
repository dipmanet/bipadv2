...
const GovernanceFields: FunctionComponent<Props> = ({ resourceEnums, faramValues,
    ...
    return (
        <>
            ...
            <SelectInput
                ...
                label="Does the facility have disaster management unit available?"
                options={booleanCondition}
                keySelector={keySelector}
                labelSelector={labelSelector}
                optionsClassName={optionsClassName}
            ...
            <SelectInput
                ...
                label="Has employee trained in disaster management?"
                options={booleanCondition}
                keySelector={keySelector}
                labelSelector={labelSelector}
                optionsClassName={optionsClassName}
            ...
            {faramValues.hasEmployeeDrrTrained
                && (
                    <TextInput
                        ...
                        label="Number of total employee trained in disaster management"
                    />
                )}

            <SelectInput
                faramElementName="hasHelipad"
                label="Does the institution has helipad?"
                options={booleanCondition}
                keySelector={keySelector}
                labelSelector={labelSelector}
                optionsClassName={optionsClassName}
