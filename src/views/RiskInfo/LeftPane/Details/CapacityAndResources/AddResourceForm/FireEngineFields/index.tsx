...
const FireEngineFields: FunctionComponent = ({
	resourceEnums,
	faramValues,
	optionsClassName,
	iconName,
			...
			{(t) => (
				<>
					...
					<TextInput
						...
						label={t(
							"Are there multiple municipalities that share the services from the firefighting apparatus?"
						)}
					/>
					<NumberInput faramElementName="capacityOfFireEngine" label={t("Capacity (Litre)")} />
					<TextInput faramElementName="vehicleNumber" label={t("Vehicle Number")} />
					<TextInput faramElementName="driverName" label={t("Driver's Name")} />
					<TextInput faramElementName="contactNumber" label={t("Driver's Contact Number")} />
					<TextInput
