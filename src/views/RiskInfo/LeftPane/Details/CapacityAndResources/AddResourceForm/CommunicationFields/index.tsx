...
const CommunicationFields: FunctionComponent<Props> = ({
	resourceEnums,
	faramValues,
	optionsClassName,
	iconName,
		...
		<Translation>
			{(t) => (
				<>
					...
					<TextInput faramElementName="towersName" label={t("Name of the tower (Radio tower)")} />
					<NumberInput
						faramElementName="coverageRadius"
						label={t("Average coverage radius in km")}
					/>
					<TextInput faramElementName="frequency" label={t("Frequency in megahertz")} />
					<SelectInput
						placeholder={language === "en" ? "Select an option" : "विकल्प चयन गर्नुहोस्"}
...
export default connect(mapStateToProps)(CommunicationFields);
