			...
			{(t) => (
				<React.Fragment>
					...
					<div className={styles.inputGroup}>
						<NumberInput faramElementName="totalArea" label={t("Total Area")} />
						<NumberInput faramElementName="usableArea" label={t("Usable Area")} />
					</div>
					<TextInput faramElementName="address" label={t("Address")} />
					<div className={styles.inputGroup}>
						<TextInput faramElementName="currentLandUse" label={t("Current Land Use")} />
						<NumberInput faramElementName="capacity" label={t("Capacity of Community Space")} />
					</div>
					<SelectInput
					...
					<div className={styles.submitButn}>
						<PrimaryButton onClick={() => postBasicInfo()}>{t("Save and Continue")}</PrimaryButton>
					</div>
					{/* )} */}
				</React.Fragment>
			)}
