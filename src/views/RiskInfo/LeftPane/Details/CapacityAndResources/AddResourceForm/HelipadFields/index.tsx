...
const HelipadFields: FunctionComponent = ({
	resourceEnums,
	faramValues,
	optionsClassName,
	iconName,
	...
	const ownerShipCondition = [
		{
			key: "Civil Aviation Authority of Nepal",
			label:
				language === "en" ? "Civil Aviation Authority of Nepal" : "नेपाल नागरिक उड्डयन प्राधिकरण",
		},
		{ key: "Nepal Army", label: language === "en" ? "Nepal Army" : "नेपाली सेना" },
		{ key: "Nepal Police", label: language === "en" ? "Nepal Police" : "नेपाल प्रहरी" },
		{
			key: "Armed Police Force",
			label: language === "en" ? "Armed Police Force" : "सशस्त्र प्रहरी बल",
		},
	...
	const surfaceType = [
		{ key: "Concrete", label: language === "en" ? "Concrete" : "कंक्रीट" },
	...
	const helipadCondition = [
		...
		{
			key: "Not in working condition",
			label: language === "en" ? "Not in working condition" : "काम गर्ने अवस्थामा छैन",
		},
	];
	return (
		<Translation>
            ...
            /> */}
					...
					<SelectInput
						...
						label={t(
							"Is the helipad build following the standard operational guidelines, 2075 of Civil Aviation Authority of Nepal?"
						)}
						...
						iconName={iconName}
					/>
					<TextInput faramElementName="area" label={t("Area of Helipad(sq m)")} />
					<TextInput faramElementName="altitude" label={t("Altitude")} />
					...
					/>
					<h1>{t("CONTACT")}</h1>
					<TextInput faramElementName="focalPersonName" label={t("Name of focal person")} />
					<TextInput faramElementName="focalPersonNumber" label={t("Contact of focal person")} />
