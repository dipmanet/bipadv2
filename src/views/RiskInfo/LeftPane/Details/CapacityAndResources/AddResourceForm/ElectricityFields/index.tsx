...
const ElectricityFields: FunctionComponent<Props> = ({
	resourceEnums,
	faramValues,
	optionsClassName,
	iconName,
	...
	const electricityStatus = [
		{ key: "Operational", label: language === "en" ? "Operational" : "संचालनमा छ " },
		{
			...
			label: language === "en" ? "Under construction" : "मर्मत चाहिन्छ",
		},
		...
		<Translation>
			{(t) => (
				<>
					...
					<TextInput faramElementName="capacityInMw" label={t("Capacity (In Megawatt)")} />
					<TextInput faramElementName="promoter" label={t("Promoter")} />
