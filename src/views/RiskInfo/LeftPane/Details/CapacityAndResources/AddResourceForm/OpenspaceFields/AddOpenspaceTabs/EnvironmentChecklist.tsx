		...
		return (
			<React.Fragment>
				{resourceId === undefined
					? allEia &&
					  allEia.map((listItem: EnvironmentAttribute) => (
					...
					: allEia &&
					  ...
					  allEia.map((listItem: EnvironmentAttribute) => {
							const eiaAvailability =
								singleEiaList && singleEiaList.filter((el) => el.eia === listItem.id);
							return (
								<React.Fragment key={listItem.id}>
									<div className={styles.environmentCheckDiv}>
										{listItem.name}
				...
				<div className={styles.stepButtons}>
					...
					<PrimaryButton
						...
						onClick={() => (resourceId === undefined ? this.postEia() : handleTabClick("media"))}>
						Save and Continue
					</PrimaryButton>
				</div>
			</React.Fragment>
