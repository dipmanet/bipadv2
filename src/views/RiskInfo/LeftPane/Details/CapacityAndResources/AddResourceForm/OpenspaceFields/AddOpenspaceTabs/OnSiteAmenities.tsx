    ...
    private postEditedAmenities = () => {
        ...
        if (singleAmenitiesList.length !== 0) {
            for (let i = 0; i < singleAmenitiesList.length; i++) {
                ...
                fetch(`${process.env.REACT_APP_API_SERVER_URL}/open-amenities/${singleAmenitiesList[i].id}/`, requestOptions)
                    .then(response => response.json())
                    .then(() => {
            ...
            <React.Fragment>
                {
                    resourceId === undefined ? (
                        allAmenities && allAmenities.map(item => (
                            <div
                        ...
                        : (
                            allAmenities && singleAmenitiesList && allAmenities.map((item: Amenity) => {
                                const eiaAvailability = singleAmenitiesList
                                    && singleAmenitiesList.filter(el => el.amenities === item.id);
                                // let latestValue =
                                        ...
                                        >
                                            ...
                                            <label className={styles.switch}>
                                                <input
                                                    ...
                                                    onClick={e => this.handleEditAmenitiesChange(
                                                        e,
                                                        item,
                                                        eiaAvailability
                                                        && eiaAvailability[0],
