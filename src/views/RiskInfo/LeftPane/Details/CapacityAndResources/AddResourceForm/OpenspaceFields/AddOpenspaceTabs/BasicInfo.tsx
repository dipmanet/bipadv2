...
const BasicInfo: React.FC<Props> = ({
	...
	<React.Fragment>
		...
		<TextInput faramElementName="oid" label="OID" />
		<TextInput faramElementName="hlcitMunicipalty" label="HLCIT-MUN" />

		<TextInput faramElementName="issue" label="Issue" />
		<div className={styles.inputGroup}>
			<TextInput faramElementName="currentLandUse" label="Current Land Use" />
			<TextInput faramElementName="catchmentArea" label="Catchment Area" />
		</div>
		<div className={styles.inputGroup}>
		...
		<TextInput faramElementName="specialFeature" label="Special Feature" />
		<div className={styles.inputGroup}>
		...
		<TextInput faramElementName="usableAreaSecond" label="Usable-2013" />
		<div className={styles.inputGroup}>
			<NumberInput faramElementName="areaChange" label="Area Changed" />
			<TextInput faramElementName="perimeter" label="Perimeter" />
		</div>
		<TextInput faramElementName="changeRemarks" label="Change Remarks" />
		...
		<div className={styles.stepButtons}>
			...
			<PrimaryButton onClick={() => postBasicInfo()}>Save and Continue</PrimaryButton>
		</div>
	</React.Fragment>
);
...
export default connect(mapStateToProps)(createConnectedRequestCoordinator<ReduxProps>()(BasicInfo));
