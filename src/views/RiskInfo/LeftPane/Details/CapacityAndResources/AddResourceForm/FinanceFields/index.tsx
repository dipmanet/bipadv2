...
const FinanceFields: FunctionComponent<Props> = ({
	resourceEnums,
	faramValues,
	optionsClassName,
	iconName,
		...
		<Translation>
			{(t) => (
				<>
					...
					<Checkbox faramElementName="bank" label={t("Bank")} />
					<Checkbox faramElementName="moneyExchange" label={t("Money Exchange")} />
					<Checkbox faramElementName="atm" label={t("ATM")} />
					<Checkbox faramElementName="hasOtherServices" label={t("Other")} />
					{faramValues.hasOtherServices && (
						<TextInput faramElementName="otherServices" label={t("Other Services")} />
					)}
					<NumberInput faramElementName="serviceUsers" label={t("Number of Service Users")} />
