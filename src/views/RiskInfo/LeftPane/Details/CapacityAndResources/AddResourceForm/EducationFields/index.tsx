...
const EducationFields: FunctionComponent<Props> = ({
	resourceEnums,
	faramValues,
	optionsClassName,
	iconName,
		...
		<Translation>
			{(t) => (
				<>
					...
					<NumberInput faramElementName="classroomCount" label={t("Number of Classrooms")} />
					<NumberInput faramElementName="area" label={t("Area Of School (Sq.Km)")} />
					...
					<NumberInput faramElementName="noOfMaleStudent" label={t("Number of Male Students")} />
					<NumberInput
						faramElementName="noOfFemaleStudent"
						label={t("Number of Female Students")}
					/>
					<NumberInput faramElementName="noOfOtherStudent" label={t("Number of Other Students")} />
					<NumberInput
					...
					<NumberInput faramElementName="noOfStudentsLessThanTen" label={t("Less than 10 years")} />
					<NumberInput
					...
					/>
					<NumberInput faramElementName="noOfStudentsMoreThanTwenty" label={t("Above 20 years")} />
					...
					{faramValues.hasOpenSpace && (
						<TextInput faramElementName="areaOfOpenSpace" label={t("Area of Open Space (Sq.Km)")} />
					)}
					<SelectInput
						placeholder={language === "en" ? "Select an option" : "विकल्प चयन गर्नुहोस्"}
					...
					<SelectInput
						...
						label={t(
							"Has disaster related awareness and training programs been conducted within the school?"
						)}
						options={booleanConditionNe}
						keySelector={keySelector}
						labelSelector={labelSelector}
