...
const requests: { [key: string]: ClientAttributes<ReduxProps, Params> } = {
    ...
    */
	addClusterPostRequest: {
		url: ({ props }) =>
			props.value ? `/inventory-item-unit/${props.value.id}/` : "/inventory-item-unit/",
...
class AddUnitForm extends React.PureComponent<Props, State> {
				...
				<Faram
					...
					<Translation>
						{(t) => (
							<>
								<ModalHeader
									title={value ? t("Edit Unit") : t("Add Unit")}
									rightComponent={
										<DangerButton
											transparent
											iconName="close"
