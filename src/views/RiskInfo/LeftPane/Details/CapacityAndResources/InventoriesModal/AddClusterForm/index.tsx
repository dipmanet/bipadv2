...
const requests: { [key: string]: ClientAttributes<ReduxProps, Params> } = {
    ...
    */
	addClusterPostRequest: {
		url: ({ props }) =>
			props.value ? `/inventory-cluster/${props.value.id}/` : "/inventory-cluster/",
...
class AddClusterForm extends React.PureComponent<Props, State> {
				...
				<Faram
					...
					<Translation>
						{(t) => (
							<>
								<ModalHeader
									title={value ? t("Edit Cluster") : t("Add Cluster")}
									rightComponent={
										<DangerButton
											transparent
											iconName="close"
