...
const requests: { [key: string]: ClientAttributes<ReduxProps, Params> } = {
    ...
    */
	addClusterPostRequest: {
		url: ({ props }) => (props.value ? `/inventory-item/${props.value.id}/` : "/inventory-item/"),
...
class AddItemForm extends React.PureComponent<Props, State> {
	...
	public render() {
		...
		const labelSelector = (d: PageType.Field) => (language === "en" ? d.title : d.titleNe);
				...
				<Faram
					...
					<Translation>
						{(t) => (
							<>
								<ModalHeader
									title={value ? t("Edit Item") : t("Add Item")}
									rightComponent={
										<DangerButton
											transparent
											iconName="close"
								...
								<ModalBody>
									...
									<TextArea faramElementName="shortDescription" label={t("Short Description")} />
									<TextArea faramElementName="description" label={t("Description")} />

									<TextArea faramElementName="dimension" label={t("Dimension")} />
									<NumberInput faramElementName="occupency" label={t("Occupancy")} />
									<TextArea faramElementName="code" label={t("Code")} />
									<SelectInput
