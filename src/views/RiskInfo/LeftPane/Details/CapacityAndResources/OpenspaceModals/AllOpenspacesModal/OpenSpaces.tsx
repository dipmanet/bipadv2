...
function createData(
    ...
    return { number, name, location, total, usable, capacity, id };
}
...
class OpenSpaces extends React.PureComponent<Props, State> {
    ...
    public componentDidUpdate(prevProps, prevState) {
        ...
        if (response !== prevProps.requests.mediaGetRequest.response) {
            ...
            if (region && adminLevel && geoarea) {
                ...
                this.setApiData(filteredApiData);
            } else {
                this.setApiData(response && response.results);
                // this.setState({ apiData: response && response.results });
            }
        }
    }

    public setApiData = (apiData) => {
    ...
    public handelSelectedRow = (id: number) => {
        ...
        this.props.handelListClick(filteredData[0], 'openspace')
    }
