			...
			<div className={styles.details}>
						...
						<div>
							...
							<ul>
								<li className={styles.ListWithImage}>
									...
									Community Space toggle, then you will land on the Abstract page.
				...
				<div>
					...
					<ol>
						...
						<li>On the Resource Type field, select community space.</li>
						<li>
							Enter the title of community space and description on the title and description field
							respectively.
						</li>
						<li>
						...
						<li>
							Scroll down and fill in all the necessary fields of the Basic Info tab, then click on
							the Save and Continue button.
						</li>
						<li>
							Similarly, fill the necessary field of the Details tab and click on the Save button
							will add community space.
						</li>
					</ol>
				</div>
			</div>
