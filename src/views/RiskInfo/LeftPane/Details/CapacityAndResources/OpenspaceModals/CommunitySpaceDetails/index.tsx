			...
			<>
				...
				{deleteModal && (
					<Modal>
						...
						/>
						<ModalBody className={styles.content}>
							<p>Are you sure to delete the community space? It cannot be undone.</p>
						</ModalBody>
						<ModalFooter className={styles.footer}>
							<DangerButton onClick={handleDeleteModal}>Close</DangerButton>
							<PrimaryButton onClick={confirmDelete}>Save</PrimaryButton>
						</ModalFooter>
					</Modal>
				)}
			</>
