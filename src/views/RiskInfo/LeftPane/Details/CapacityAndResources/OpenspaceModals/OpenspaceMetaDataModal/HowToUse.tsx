...
class HowToUse extends React.PureComponent<Props> {
	public render() {
		const {
			...
			<div className={styles.details}>
				<div>
					...
					<ol>
						...
						<li className={styles.ListWithImage}>
							3. Open Spaces will be plotted on the map. Now you can zoom in to the desired Open
							Spaces and click on it to view the details.
				...
				<div>
					...
					<ul>
						<li className={styles.ListWithImage}>
							1. On the Capacity and Resource Page, Click on the table icon on the side of
				...
				<div>
					...
					<ul>
						<li className={styles.ListWithImage}>
							1. On the Capacity and Resource page, click on the Info icon on the side of the
							Humanitarian Open Spaces toggle, then you will land on the Abstract page.
				...
				<div>
					...
					<ul>
						...
						<li className={styles.ListWithImage}>
							4. Tick the Drone image checkbox, then the drone image on a map over the Open Spaces
							will be displayed.
				...
				<div>
					...
					<ul style={{ listStyleType: "none" }}>
						<li className={styles.ListWithImage}>
							1. On the Capacity and Resource page, Toggling on the Humanitarians Open Spaces will
							display the open space, and it’s a cluster on the map if it&apos;s too close.
							<img src={MapOpenspace} alt="toggle" />
						</li>
						<li className={styles.ListWithImage}>
							2. Clicking on the cluster will split the Open Spaces.
						</li>
						<li className={styles.ListWithImage}>
						...
						<li className={styles.ListWithImage}>
							4. Clicking on the View Detail button on the Open Spaces popup will display all the
							details of Open Spaces.
							<img src={ViewDetailOpenspace} alt="map" />
						</li>
						<li className={styles.ListWithImage}>
							5. Tick the Drone image checkbox, then the drone image on a map over the Open Spaces
							will be displayed.
							<img src={DroneImageOpenspace} alt="map" />
						</li>
					</ul>
				...
				{authenticated && (
					<div>
						...
						<ol>
							<li>
								On the Capacity and Resource Page, Click on the “ADD RESOURCE” button on the left
								sidebar.
							</li>
							<li>On the Resource Type field, select Open Spaces.</li>
							<li>
								Enter the title of Open Spaces and description on the title and description field
								respectively.
							</li>
							<li>
								Type the Region of Open Spaces on the region field or choose the location from the
								map.
							</li>
							<li>
								Scroll down and fill in all the necessary fields of the Basic Info tab, then click
								on the Save and Continue button.
							</li>
							<li>
								Similarly, fill in the necessary field of the Details tab and click on the Save and
								Continue button.
							</li>
							<li>On the Suggested Use Tab, choose the item by clicking on the checkbox.</li>
							<li>
								On the Amenities tab, choose the amenities with the help of a switch and you can
								also add the amenities description on the note field below each amenities.
							</li>
							<li>Environment Checklist selection is similar to that of amenities.</li>
							<li>
								On the Media tab, you can upload the images or photos of Open Spaces by clicking on
								choose files. Clicking on the save button will successfully add the Open Spaces.
							</li>
						</ol>
					</div>
				)}
