...
import { createRequestClient, NewProps, createConnectedRequestCoordinator } from "#request";
						...
						{(t) => (
							<>
								...
								<ModalFooter>
									...
									<PrimaryButton type="submit" disabled={pristine} onClick={this.handleSearch}>
										{t("Search")}
									</PrimaryButton>
								</ModalFooter>
							</>
...
export default connect(
	mapStateToProps,
	mapDispatchToProps
)(createConnectedRequestCoordinator<PropsWithRedux>()(createRequestClient()(SearchModal)));
