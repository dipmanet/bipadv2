			...
			fetchedData.map((item) => {
				...
				if (orgTypeObj.length > 0) {
					mergedList.push({
						...
						trainingDuration: trainedContactsObj.map((trainings) => trainings.durationDays),
					});
					setMergedData(mergedList);
					const chkArr = Array.from(Array(mergedList.length).keys());
					setCheckedRows(chkArr);
					setDataWithIndex(
						mergedList.map((items, i) => ({ ...items, index: i, selectedRow: true }))
					);
				} else {
				...
				<div className={styles.tabsPageContainer}>
					...
					<div className={styles.palikaTable}>
						...
						{!loader && mergedData.length === 0 && (
							<h2>
								<Gt section={Translations.ContactNoDataMessage} />
							</h2>
						)}
					</div>
					{!loader && (
													...
													<tr>
														...
														<td>
															<input
																...
																placeholder={
																	drrmLanguage.language === "np"
																		? Translations.ContactsName.np
																		: Translations.ContactsName.en
																}
														...
														<td>
															<select
																...
																<option value="">
																	{drrmLanguage.language === "np"
																		? Translations.ContactTypeOfOrganization.np
														...
														<td>
															<input
																...
																placeholder={
																	drrmLanguage.language === "np"
																		? Translations.ContactNameOfOrganization.np
																		: Translations.ContactNameOfOrganization.en
																}
															/>
														</td>
														<td>
															<input
																...
																placeholder={
																	drrmLanguage.language === "np"
																		? Translations.ContactPosition.np
																		: Translations.ContactPosition.en
																}
														...
														<td>
															<input
																...
																placeholder={
																	drrmLanguage.language === "np"
																		? Translations.ContactTrainingTitle.np
																		: Translations.ContactTrainingTitle.en
																}
															/>
														</td>
														<td>
											...
											if (data && data.item && nonGovContactId !== data.item.id) {
												return (
													<tr key={data.item.id}>
														...
														<td>
															{drrmLanguage.language === "np" ? data.hazardNameNp : data.hazardName}
														</td>
											...
											<tr>
												...
												<td>
													<input
														...
														onChange={handleContact}
														placeholder={
															drrmLanguage.language === "np" ? "सम्पर्क नम्बर" : "Contact Number"
														}
													/>
												</td>
												<td>
				...
				<div className={styles.budgetPreviewContainer}>
					<div className={styles.simElementsContainer}>
						...
						<div className={styles.simRow}>
							...
							<div className={styles.simElements}>
								<div className={styles.circlePatch}>{trainingsList.length}</div>
								<p className={styles.simDesc}>
					...
					<div className={styles.simElementsContainer}>
						<p>
							<Gt section={Translations.TrainingRelatedActivitiesList} />
						</p>
						<div className={styles.simRow}>
							<div className={styles.simElements}>
								<ul>
									{trainingsList.length > 0 &&
										trainingsList.map((item) => <li key={Math.random()}>{item}</li>)}
								</ul>
							</div>
						</div>
					</div>
...
export default connect(
	mapStateToProps,
	mapDispatchToProps
)(createConnectedRequestCoordinator<PropsWithRedux>()(createRequestClient(requests)(Contacts)));
