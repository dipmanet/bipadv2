				...
				<div className={styles.tabsPageContainer}>
					...
					<div className={styles.palikaTable}>
							...
							<tbody>
								...
								{!props.annex && !loader && (
									<tr>
										...
										<td />
										<td>
											<button type="button" className={styles.savebtn} onClick={handleAddResource}>
						...
						{!loader && filteredtData.length === 0 && (
							<h2>
								<Gt section={Translations.ResourcesNoDataMessage} />
							</h2>
						)}
						{!loader && !props.annex && (
							<>
...
export default connect(
	...
	createConnectedRequestCoordinator<PropsWithRedux>()(createRequestClient(requests)(CriticalInfra))
);
