...
const Leadership = (props: Props) => {
	...
	const { fiscalYear, cao, mayor, focalPerson } = generalData;
					...
					<ul>
						<li>
							<span className={styles.darker}>
								{(mayor && mayor.name) || <Gt section={Translations.MayorNameUnavailable} />}
								(
								<Gt section={Translations.Mayor} />)
							</span>
						</li>
						<li>{(mayor && mayor.email) || <Gt section={Translations.MayorEmailUnavailable} />}</li>
						<li>
							{(mayor && mayor.mobileNumber) || <Gt section={Translations.MayorPhoneUnavailable} />}
						</li>
					</ul>
				</div>
				<div className={styles.leaderItem}>
					<ul>
						<li>
							<span className={styles.darker}>
								{(cao && cao.name) || <Gt section={Translations.CaoNameUnavailable} />}
								(
								<Gt section={Translations.ChiefAdminstrative} />)
							</span>
						</li>
						<li>{(cao && cao.email) || <Gt section={Translations.CaoEmailUnavailable} />}</li>
						<li>
							{(cao && cao.mobileNumber) || <Gt section={Translations.CaoPhoneUnavailable} />}
						</li>
					</ul>
				</div>
				<div className={styles.leaderItem}>
...
export default connect(
	mapStateToProps,
	undefined
)(createConnectedRequestCoordinator<PropsWithRedux>()(createRequestClient(requests)(Leadership)));
