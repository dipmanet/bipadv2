	...
	return (
		<div className={styles.footer}>
			<div className={styles.leftContainer}>
				<h2>
					<Gt section={Translations.ContactUs} />
				</h2>
					...
					<ul>
						...
						{drrmLanguage.language === "en" && (
							<li
								className={
									styles.munTitle
								}>{`WEB: https://www.${municipalityName.toLowerCase()}mun.gov.np/en`}</li>
						)}
					</ul>
				</div>
			</div>
...
export default connect(
	mapStateToProps,
	undefined
)(createConnectedRequestCoordinator<PropsWithRedux>()(createRequestClient(requests)(Footer)));
