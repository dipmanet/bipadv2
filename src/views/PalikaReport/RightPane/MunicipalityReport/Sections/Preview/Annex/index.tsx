...
const Annex = (props: Props) => {
	const { generalData, programAndPolicyData, budgetData, budgetActivityData, url, localMembers } =
		props;
	...
	return (
		<div className={styles.previewContainer}>
			...
			<h1>Annex E</h1>
			<div className={styles.rowOne}>
				<Organisation annex handlePrevClick={() => {}} handleNextClick={() => {}} />
			</div>
			<h1>Annex F</h1>
			<div className={styles.rowOne}>
				<Inventory annex handlePrevClick={() => {}} handleNextClick={() => {}} />
			</div>
			<h1>Annex G</h1>
			<div className={styles.rowOne}>
				<CriticalInfra annex handlePrevClick={() => {}} handleNextClick={() => {}} />
			</div>
