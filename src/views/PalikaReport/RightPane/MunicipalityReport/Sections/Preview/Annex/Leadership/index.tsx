			...
			<div className={styles.itemRow}>
				<div className={styles.leaderItem}>
					<ul>
						...
						<li>{(mayor && mayor.email) || "Email Available"}</li>
						<li>{(mayor && mayor.mobileNumber) || "Phone Available"}</li>
					</ul>
				</div>
				<div className={styles.leaderItem}>
					<ul>
						...
						<li>{(cao && cao.email) || "Email Unavailable"}</li>
						<li>{(cao && cao.mobileNumber) || "Phone Unavailable"}</li>
					</ul>
				</div>
				<div className={styles.leaderItem}>
					<ul>
						...
						<li>{(focalPerson && focalPerson.email) || "Email Unvailable"}</li>
						<li>{(focalPerson && focalPerson.mobileNumber) || "Phone Unvailable"}</li>
					</ul>
				</div>
			</div>
		</div>
