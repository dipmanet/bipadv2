...
const Budget = (props: Props) => {
	...
	const {
		user: { profile },
		requests: { BudgetPostRequest, BudgetGetRequest, BudgetPutRequest },
	} = props;
	...
	useEffect(() => {
		if (annualBudgetData.length > 0) {
			const { totalBudgetNrs, disasterBudgetNrs, otherBudgetNrs } = annualBudgetData[0];
																...
																<tr>
																	...
																	<td>
																		<input
																			...
																			placeholder="Enter Total Municipal Budget"
																	...
																	<td>
																		<input
																			...
																			className={styles.inputContainer}
																			value={drrFund}
																			placeholder="Enter DRR Fund of the Municipality"
																	...
																	<td>
																		<input
																			...
																			placeholder="Other DRR Related Funding"
							...
							<div className={styles.budgetDetailsContainer}>
								<div className={styles.budgetDetails}>
									<ul>
										<li>
											<h2>
												<Gt section={Translations.Rupees} /> {municipalBudget || "-"}
											</h2>
										</li>
										<li>
									...
									<ul>
										<li className={styles.lighter}>
											{/* <span > */}
											{drrFund && municipalBudget
												? ((Number(drrFund) / Number(municipalBudget)) * 100).toFixed(0)
												: "-"}
											{"%"}
											<Gt section={Translations.approx} /> <Gt section={Translations.OfMunBudget} />
											{/* </span> */}
										</li>
										<li>
											<h2>
												<Gt section={Translations.Rupees} /> {drrFund}
											</h2>
										</li>
										<li>
											<span className={styles.light}>
								...
								<div className={styles.budgetDetails}>
									<ul>
										<li>
											<h2>
												<Gt section={Translations.Rupees} /> {additionalFund || "-"}
											</h2>
										</li>
										<li>
											<span className={styles.light}>
...
export default connect(
	mapStateToProps,
	mapDispatchToProps
)(createConnectedRequestCoordinator<PropsWithRedux>()(createRequestClient(requests)(Budget)));
