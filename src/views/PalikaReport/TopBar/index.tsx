...
import { setPalikaLanguageAction } from "#actionCreators";
import {
	districtsSelector,
	drrmRegionSelector,
...
const TopBar = (props: Props) => {
	...
	return (
		<div
			className={municipalityName !== "Not defined" ? styles.toBarContainer : styles.notLoggedIn}>
			{municipalityName !== "Not defined" ? (
				<p>
					{municipalityName} <Gt section={Translations.MunicipalitySingle} />, {districtName}{" "}
					<Gt section={Translations.dashboardTblHeaderDistrict} />, {provinceName}{" "}
			...
			<div className={styles.languageButton}>
				<button
					...
					className={
						language === "en" ? _cs(styles.engButton, styles.selectedLanguage) : styles.engButton
					}
					type="button">
					EN
				</button>
				<button
					onClick={handleLangButton}
					className={
						language === "np" ? _cs(styles.nepButton, styles.selectedLanguage) : styles.nepButton
					}
					type="button">
					ने
				</button>
