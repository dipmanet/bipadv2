...
const PalikaReport: React.FC<Props> = (props: Props) => {
	...
	const {
		requests: { PalikaReportGetRequest, FiscalYearFetch },
	} = props;
	...
	const TableHeaderForTable = finalTableHeader.filter(
		(item) =>
			item !== "ID" &&
			item !== "Created on" &&
			item !== "Modified on" &&
	...
	const TableHeaderForMatchingData = Object.keys(tableHeader).filter(
		(item) =>
			item !== "id" &&
			item !== "createdOn" &&
			item !== "modifiedOn" &&
					...
					<div className={styles.firstPageContainer}>
						<div className={styles.languageButton}>
							...
							<button
								...
								className={
									language === "np"
										? _cs(styles.nepButton, styles.selectedLanguage)
										: styles.nepButton
								}
								type="button">
								ने
			...
			<div className={styles.reportContainer}>
				<div className={styles.leftContainer}>
					<div className={styles.heading}>
						<div className={styles.bipad}>BIPAD</div>
						<div className={styles.report}>DRRM Data Profile</div>
					</div>
									...
									{submenuId === 1 && (
										<div className={styles.rightContainerFilters}>
											...
											{!showReportEdit && submenuId === 1 && filtered ? (
												<button type="submit" className={styles.submitBut} onClick={handleSubmit}>
												...
												submenuId === 1 && (
													<button
														...
														className={
															disableFilterButton ? styles.submitButDisabled : styles.submitBut
														}
...
export default connect(
	mapStateToProps,
	mapDispatchToProps
)(createConnectedRequestCoordinator<PropsWithRedux>()(createRequestClient(requests)(PalikaReport)));
