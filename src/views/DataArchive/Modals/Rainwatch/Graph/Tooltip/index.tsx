			...
			return (
				<div className={styles.tooltip}>
					...
					<div className={styles.value}>
						...
						{innerPayload.accHourly === null || isNaN(Number(innerPayload.accHourly))
							? "N/A"
							: `${innerPayload.accHourly.toFixed(2)} mm`}
					</div>
					<div className={styles.value}>
						<b>Cumulative Rain: </b>
						{innerPayload.cumulativeHourData === null ||
						isNaN(Number(innerPayload.cumulativeHourData))
							? "N/A"
							: `${innerPayload.cumulativeHourData.toFixed(2)} mm`}
					</div>
				</div>
			);
		}
		if (periodCode === "daily") {
			return (
				<div className={styles.tooltip}>
					...
					<div className={styles.value}>
						<b>Accumulated Rain: </b>
						{innerPayload.accDaily === null || isNaN(Number(innerPayload.accDaily))
							? "N/A"
							: `${innerPayload.accDaily.toFixed(2)} mm`}
					</div>
					<div className={styles.value}>
						<b>Cumulative Rain: </b>
						{innerPayload.cumulativeDailyData === null ||
						isNaN(Number(innerPayload.cumulativeDailyData))
							? "N/A"
							: `${innerPayload.cumulativeDailyData.toFixed(2)} mm`}
					</div>
				</div>
			);
		}
		if (periodCode === "monthly") {
			return (
				<div className={styles.tooltip}>
					...
					<div className={styles.value}>
						<b>Accumulated Rain: </b>
						{innerPayload.accMonthly === null || isNaN(Number(innerPayload.accMonthly))
							? "N/A"
							: `${innerPayload.accMonthly.toFixed(2)} mm`}
					</div>
					<div className={styles.value}>
						<b>Cumulative Rain: </b>
						{innerPayload.cumulativeMonthlyData === null ||
						isNaN(Number(innerPayload.cumulativeMonthlyData))
							? "N/A"
							: `${innerPayload.cumulativeMonthlyData.toFixed(2)} mm`}
					</div>
				</div>
			);
		}
