...
const generateFileName = (intervalCode: string, periodCode: string, stationName: string) => {
...
const TableView = (props: Props) => {
	...
	const formattedTableData = convertNormalTableToCsv(csvData, header);
		...
		<div className={styles.tableView}>
			<div className={styles.header}>
				...
				<DownloadButton
					...
					<h4>Download</h4>
					<Icon className={styles.chartDownload} name="download" />
				</DownloadButton>
			</div>
