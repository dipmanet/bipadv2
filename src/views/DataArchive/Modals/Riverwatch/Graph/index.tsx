...
const getChartTitle = (periodCode: string, stationName: string, date: string) => {
...
const Graph = (props: Props) => {
	...
	const calculatedTitle = getChartTitle(periodCode || "", stationName, date);
								...
								<LineChart
									...
									<YAxis
										domain={[
											0,
											(dataMax) =>
												dataMax > (dangerLevel || warningLevel || 0)
													? dataMax
													: dangerLevel || warningLevel,
										]}
									/>
									<Tooltip content={<CustomTooltip periodCode={periodCode} />} />
									<Legend />
									{isMinuteSelected && (
										<Line
											type="monotone"
									...
									{!isMinuteSelected && (
										<Line
											type="monotone"
											dot={false}
											name="Min Water Level (m)"
											dataKey="waterLevelMin"
											stroke="blue"
										/>
									)}
									{!isMinuteSelected && (
										<Line
											type="monotone"
											dot={false}
											name="Max Water Level (m)"
											dataKey="waterLevelMax"
											stroke="red"
										/>
									)}
									{!isMinuteSelected && (
