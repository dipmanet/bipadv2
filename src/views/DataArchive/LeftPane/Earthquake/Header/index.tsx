		...
		<header className={styles.header}>
			<div className={styles.tabs}>
				<div
					...
					role="presentation">
					<div className={styles.value}>{dataCount}</div>
					<div className={styles.title}>
						<div className={styles.text}>Total Events</div>
					</div>
				</div>
				<div
					...
					<div className={styles.text}>Visualization</div>
				</div>
				<div
					className={_cs(styles.tab, activeView === "charts" && styles.active)}
					role="presentation"
					onClick={handleChartsButtonClick}>
					<Icon className={styles.chartIcon} name="earhtquakeCharts" />
					<div className={styles.text}>Chart</div>
				</div>
			</div>
		</header>
	);
