...
class RiverModal extends React.PureComponent<Props> {
	public constructor(props: Props) {
		...
		this.riverWatchHeader = [
			...
			},
			{
				...
				sortable: true,
				comparator: (a, b) =>
					compareNumber(a.waterLevel ? a.waterLevel : 0, b.waterLevel ? b.waterLevel : 0),
				modifier: (row: DataArchiveRiver) => {
	...
	public render() {
		const { dataArchiveRiver, closeModal } = this.props;
		...
		return (
			<Modal
				...
				<ModalFooter>
					...
					<DownloadButton value={formattedTableData} name="River Watch.csv">
						Download
					</DownloadButton>
				</ModalFooter>
			</Modal>
