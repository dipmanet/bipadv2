...
class PollutionModal extends React.PureComponent<Props> {
	...
	public render() {
		const { dataArchivePollution, closeModal } = this.props;

		const formattedTableData = convertNormalTableToCsv(dataArchivePollution, this.pollutionHeader);
		return (
			<Modal
				// closeOnEscape
				// onClose={closeModal}
				...
				<ModalFooter>
					...
					<DownloadButton value={formattedTableData} name="DataArchivePollution.csv">
						Download
					</DownloadButton>
				</ModalFooter>
			</Modal>
