...
const PollutionLegend = () => {
	const { data }: DataArchiveContextProps = useContext(DataArchiveContext);
	const autoPollutionLegends = getPollutionLegends(data || [], pollutionLegendItems);
	return (
		<div className={styles.legendContainer}>
			<header className={styles.header}>
				<ScalableVectorGraphics className={styles.legendIcon} src={PollutionIcon} alt="Pollution" />
				<h4 className={styles.heading}>Pollution (AQI Value)</h4>
			</header>
			<Legend
