...
class SetNewPassword extends React.PureComponent {
	private static schema = {
		fields: {
			password: [requiredCondition, lengthGreaterThanCondition(7)],
			newpassword: [requiredCondition, lengthGreaterThanCondition(7)],
		},
	};
	...
	public render() {
		const { faramErrors, faramValues, pending, matchError, regexError, serverErrorMsg } =
			this.state;
		return (
			<Page
				leftContent={null}
											...
											<div className={styles.newLoginForm}>
												...
												{regexError ? (
													<ul className={styles.matchError}>
														Please make sure you include atleast one of the following:
														<li>Minimum 8 characters</li>
														<li>Atleast one of: !@#$%^&*</li>
												...
												{serverErrorMsg ? (
													<span className={styles.matchErr}>{serverErrorMsg}</span>
												) : (
													""
												)}
...
export default connect(
	...
	createConnectedRequestCoordinator<ReduxProps>()(
		createRequestClient(requestOptions)(SetNewPassword)
	)
);
