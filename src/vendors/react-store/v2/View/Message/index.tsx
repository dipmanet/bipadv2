...
function Message(props: Props) {
	const { maxFontSize, maxPaddingSize, minFontSize, minPaddingSize, resizeFactor } = props;
	...
	const handleResize = useCallback(
		...
		[maxFontSize, maxPaddingSize, minFontSize, minPaddingSize, resizeFactor, containerRef]
	);

	useResizeObserver(containerRef, showChildren, handleResize);

	const { className: classNameFromProps, children } = props;

	const className = _cs(classNameFromProps, styles.message);
