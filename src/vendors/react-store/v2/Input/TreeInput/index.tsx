...
function TreeNode<T, K extends OptionKey>(props: TreeNodeProps<T, K>) {
	...
	const ownOptions = useMemo(
		() => allOwnOptions && allOwnOptions.filter((option) => parentKeySelector(option) === nodeKey),
	...
	return (
		<div className={_cs(styles.treeNode, className, collapsed && styles.collapsed)}>
			<div className={styles.left}>
				...
				/>
				{!collapsed && !isLeaf && (
					<div className={styles.stem} role="presentation" onClick={handleCollapseOption}>
...
function TreeInput<T, K extends OptionKey = string>(props: TreeProps<T, K>) {
	...
	const relations = useMemo(
		() => generateExtendedRelations(options, keySelector, parentKeySelector),
