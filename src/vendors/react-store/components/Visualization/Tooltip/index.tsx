...
const propTypes = {
	 ...
	 */
	initialChildren: PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.node]),
	/**
...
export default class Tooltip extends React.PureComponent {
	...
	show = () => {
		// show tooltip
		this.getd3Tooltip().style("opacity", 1);
	};

	hide = () => {
		// hide tooltip
		this.getd3Tooltip().style("opacity", 0);
	};
