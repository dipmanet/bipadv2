...
const ForceDirectedGraphContainer = (WrappedComponent) => {
	const WrapperComponent = class extends React.PureComponent {
		...
		render() {
			const { className: classNameFromProps, ...otherProps } = this.props;

			const className = [styles.container, classNameFromProps].join(" ");
			...
			return (
				<div className={className}>
					...
					<WrappedComponent className={styles.wrapped} {...otherProps} />
				</div>
			);
		}
	};
