...
const defaultProps = {
	...
	hoverChildren: <Message>Drop here</Message>,
	disabled: false,
};
...
export default class DropZone extends React.Component {
	...
	render() {
		...
		const className = _cs(classNameFromProps, "drop-zone", styles.dropZone);
		...
		return (
			<div
				...
				{children}
				{isBeingDraggedOver && (
					<div className={_cs(hoverChildrenClassName, styles.hoverChildren)}>{hoverChildren}</div>
				)}
			</div>
		);
	}
