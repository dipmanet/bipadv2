...
class ListInput extends React.PureComponent {
	...
	getClassName() {
		...
		const classNames = [className, "list-input", styles.listInput];
	...
	renderItem = (key, data) => {
		const { labelSelector, disabled, readOnly } = this.props;

		return (
			<div key={key} className={styles.item}>
				<div className={styles.label}>{labelSelector(data)}</div>
				<Button
