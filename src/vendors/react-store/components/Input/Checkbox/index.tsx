...
class Checkbox extends React.PureComponent {
	...
	render() {
		...
		const spanClassName = _cs(styles.checkmark, "checkmark");

		const inputClassName = _cs("input", styles.input);

		const labelClassName = _cs("label", styles.label);

		return (
			<label htmlFor={this.inputId} className={className} title={tooltip}>
				<Icon name={value ? checkboxType : "checkboxOutlineBlank"} className={spanClassName} />
				<input
					id={this.inputId}
