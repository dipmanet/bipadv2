...
export default class Header extends React.PureComponent {
	...
	handleClick = (e) => {
		const { onClick, uniqueKey, disabled } = this.props;
	...
	render() {
		const { className, highlighted, hoverable, uniqueKey, children, columnHighlighted, disabled } =
			this.props;
		...
		return (
			<th className={thClassName} role="gridcell" onClick={this.handleClick}>
