...
const propTypes = {
	...
	tooltip: PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.node]),
...
export default class Tooltip extends React.Component {
	...
	render() {
		const { tooltip, children: child, className, center } = this.props;
