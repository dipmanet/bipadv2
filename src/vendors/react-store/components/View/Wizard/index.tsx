...
export default class Wizard extends React.Component {
	...
	render() {
		const { children, className: classNameFromProps, ...otherProps } = this.props;
		const { visiblePage, className } = this.state;
		...
		return (
			<div className={`${className} ${classNameFromProps}`} key={visiblePage}>
