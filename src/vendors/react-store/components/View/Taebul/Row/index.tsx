...
const propTypes = {
	...
	datumKey: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
...
export default class Row extends React.PureComponent {
	...
	cellRendererParams = (columnKey, column) => {
		const { datum, datumKey, settings } = this.props;

		const { cellRendererParams, cellRenderer } = column;
