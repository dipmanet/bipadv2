export default {
	nepal: {
		url: `${import.meta.env.REACT_APP_MAP_SOURCE_NEPAL}`,
		layers: {
	...
	wardFillLocalTikapur: {
		url: `${import.meta.env.REACT_APP_MAP_SOURCE_TIKAPUR}`,
		layers: {
			ward: "tikapur_ward_boundary-4i0qv2",
		},
	},
	wardFillLocalGulariya: {
		url: `${import.meta.env.REACT_APP_MAP_SOURCE_GULARIYA}`,
		layers: {
			ward: "mun_gulariya-5k57lz",
		},
	},
	nepalCentroid: {
		url: `${import.meta.env.REACT_APP_MAP_SOURCE_NEPAL_CENTROID}`,
		layers: {
	...
	populationDensity: {
		// url: `${import.meta.env.REACT_APP_VIZ_RISK_MAP_SOURCE_DENSITY_POPULATION}`,
	...
	criticalInfrastructures: {
		// url: `${import.meta.env.REACT_APP_VIZ_RISK_MAP_SOURCE_CRITICAL_INFRASTRUCTURES}`,
