...
export default {
    ...
    pollutionPoint: {
        ...
        circle: {
            ...
            'circle-stroke-width': ['case', ['all',
                ['boolean', ['feature-state', 'hover'], false],
                ['==', ['feature-state', 'dataSource'], 'real-time-pollution-points'],
            ],
            3,
            1,
            ],
    ...
    earthquakePoint: {
        circle: {
            ...
            'circle-stroke-width': ['case', ['all',
                ['boolean', ['feature-state', 'hover'], false],
                ['==', ['feature-state', 'dataSource'], 'real-time-earthquake-points'],
            ],
            2,
            0,
            ],
