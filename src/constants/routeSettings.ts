...
const routeSettings: SomeRoute[] = [
    ...
    },
    {
        ...
        title: 'Feedback',
        path: '/feedback-1/',
        load: () => import('../views/FeedbackSupport/Feedback/FeedbackOne'),
        navbar: false,
    },
    {
        name: 'feedback&support',
        title: 'Feedback',
        path: '/feedback-2/',
        load: () => import('../views/FeedbackSupport/Feedback/FeedbackTwo'),
        navbar: false,
    },
    {
        name: 'feedback&support',
        title: 'Feedback',
        path: '/feedback-3/',
        load: () => import('../views/FeedbackSupport/Feedback/FeedbackThree'),
        navbar: false,
    },
    {
        name: 'feedback&support',
        title: 'Support',
        path: '/support-1/',
        load: () => import('../views/FeedbackSupport/Support/SupportOne'),
        navbar: false,
    },
    {
        name: 'feedback&support',
        title: 'Support',
        path: '/support-2/',
        load: () => import('../views/FeedbackSupport/Support/SupportTwo'),
        navbar: false,
    },
    {
